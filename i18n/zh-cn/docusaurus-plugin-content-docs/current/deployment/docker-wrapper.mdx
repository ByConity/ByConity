...
当前将 ByConity 部署到物理服务器的方式是通过 docker wrapper 进行部署。您可以按照本[指南](https://github.com/ByConity/ByConity/tree/master/docker/executable_wrapper/Update_docker_image.md)从源代码构建 docker 包装器映像。
