...
-- SET NAMES latin1;
select CONVERT(CAST(SUBSTRING_INDEX(FORMAT(1,'1111'), FORMAT('','Zpq'),1) 
...
--echo # Testing that utf8mb4 and utf32 are superset for all Unicode
...
-- utf8mb4 and utf32 are the only supersets for utf8
