...
select * from t1 where b > '2000-01-01' order by b;
...
select * from t1 where b > '2000-01-01 00:00:00' order by b;
...
select * from t1 where b > '00:00:00' order by b;
...
select * from t1 where b > 2000 order by b;
...
select a from t1 where b > b'00000' order by b;
...
select a from t1 where b > b'000000000000000' order by b;
...
select * from t1 where b < 10 OR b IS NULL order by b;
select * from t1 where b < 10 ORDER BY b;
select * from t1 where b < 10 ORDER BY b DESC;
drop table t1;
