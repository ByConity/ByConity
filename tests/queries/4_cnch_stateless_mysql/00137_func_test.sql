...
--
select 'a' = 'A';
select 'a' = 'A' COLLATE koi8r_general_ci;
explain extended select 'a' = 'A' COLLATE koi8r_general_ci;
select 'a' = 'A' COLLATE koi8r_bin;
select 'a' COLLATE koi8r_general_ci = 'A';
select 'a' COLLATE koi8r_bin = 'A';
--error 1267
select 'a' COLLATE koi8r_bin = 'A' COLLATE koi8r_general_ci;
--error 1267
select 'a' = _latin1'A';

select strcmp('a', 'A');
select strcmp('a', 'A' COLLATE koi8r_general_ci);
select strcmp('a', 'A' COLLATE koi8r_bin);
select strcmp('a' COLLATE koi8r_general_ci, 'A');
select strcmp('a' COLLATE koi8r_bin, 'A');
--error 1267
select strcmp('a' COLLATE koi8r_general_ci, 'A' COLLATE koi8r_bin);
--error 1267
select strcmp('a', _latin1'A');

select 'a' LIKE 'A';
select 'a' LIKE 'A' COLLATE koi8r_general_ci;
select 'a' LIKE 'A' COLLATE koi8r_bin;
select 'a' COLLATE koi8r_general_ci LIKE 'A';
select 'a' COLLATE koi8r_bin LIKE 'A';
--error 1267
select 'a' COLLATE koi8r_general_ci LIKE 'A' COLLATE koi8r_bin;
--error 1267
select 'a' LIKE _latin1'A';
