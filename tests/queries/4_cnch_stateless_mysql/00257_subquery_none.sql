...
-- SELECT (SELECT 1 FROM (SELECT 1) as b HAVING a=1) as a; -- {serverError 47}
-- error ER_ILLEGAL_REFERENCE
-- SELECT (SELECT 1 FROM (SELECT 1) as b HAVING b=1) as a,(SELECT 1 FROM (SELECT 1) as c HAVING a=1) as b; -- {serverError 47}
SELECT (SELECT 1),MAX(1) FROM (SELECT 1) as a;
-- error ER_ILLEGAL_REFERENCE
-- SELECT (SELECT a) as a; --{serverError 47}
-- EXPLAIN EXTENDED SELECT 1 FROM (SELECT 1 as a) as b  HAVING (SELECT a)=1; -- {serverError 3003}
-- SELECT 1 FROM (SELECT 1 as a) as b HAVING (SELECT a)=1; -- {serverError 3003}
-- error ER_BAD_FIELD_ERROR
-- SELECT (SELECT 1), a; --{serverError 47}
SELECT 1 as a FROM (SELECT 1) as b HAVING (SELECT a)=1;
-- error ER_BAD_FIELD_ERROR
-- SELECT 1 FROM (SELECT (SELECT a) b) c; --{serverError 47}
SELECT * FROM (SELECT 1 as id) b WHERE id IN (SELECT * FROM (SELECT 1 as id) c ORDER BY id);
-- error ER_OPERAND_COLUMNS
-- SELECT * FROM (SELECT 1) a  WHERE 1 IN (SELECT 1,1); --{serverError 20}
SELECT 1 IN (SELECT 1);
SELECT 1 FROM (SELECT 1 as a) b WHERE 1 IN (SELECT (SELECT a));
-- error ER_BAD_FIELD_ERROR
-- SELECT (SELECT 1) as a FROM (SELECT 1) b WHERE (SELECT a) IS NULL; --{serverError 47}
-- error ER_BAD_FIELD_ERROR
-- SELECT (SELECT 1) as a FROM (SELECT 1) b WHERE (SELECT a) IS NOT NULL; --{serverError 47}
-- ADB also not support
...
INSERT INTO `t2` (`db_id`, `name`, `primary_uid`, `secondary_uid`) VALUES (18, 'Not Set 1', 0, 0),(19, 'Valid', 1, 2),(20, 'Valid 2', 1, 2),(21, 'Should Not Return', 1, 2),(26, 'Not Set 2', 0, 0),(-1, 'ALL DB', 0, 0);
