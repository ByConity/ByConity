...
-- # SET 'aaaaaaaaaaaaaaaa'=REPEAT('a', 16);
--echo #### aes-128-cbc
-- SELECT @@session.block_encryption_mode INTO @save_block_encryption_mode;
-- eval SET SESSION block_encryption_mode="aes-128-cbc";
SELECT 'my_text' = AES_DECRYPT(AES_ENCRYPT('my_text', 'my_key_string', 'aaaaaaaaaaaaaaaa', 'pbkdf2_hmac'), 'my_key_string', 'aaaaaaaaaaaaaaaa', 'pbkdf2_hmac');
SELECT 'my_text' = AES_DECRYPT(AES_ENCRYPT('my_text', 'my_key_string', 'aaaaaaaaaaaaaaaa', 'pbkdf2_hmac', 'salt'), 'my_key_string', 'aaaaaaaaaaaaaaaa', 'pbkdf2_hmac', 'salt');
SELECT 'my_text' = AES_DECRYPT(AES_ENCRYPT('my_text', 'my_key_string', 'aaaaaaaaaaaaaaaa', 'pbkdf2_hmac', 'salt', '10001'), 'my_key_string', 'aaaaaaaaaaaaaaaa', 'pbkdf2_hmac', 'salt', '10001');
