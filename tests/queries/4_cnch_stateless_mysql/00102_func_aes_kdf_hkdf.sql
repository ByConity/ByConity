...
SELECT 'my_text' = AES_DECRYPT(AES_ENCRYPT('my_text', 'my_key_string', 'aaaaaaaaaaaaaaaa', 'hkdf'), 'my_key_string', 'aaaaaaaaaaaaaaaa', 'hkdf');
SELECT 'my_text' = AES_DECRYPT(AES_ENCRYPT('my_text', 'my_key_string', 'aaaaaaaaaaaaaaaa', 'hkdf', 'salt'), 'my_key_string', 'aaaaaaaaaaaaaaaa', 'hkdf', 'salt');
SELECT 'my_text' = AES_DECRYPT(AES_ENCRYPT('my_text', 'my_key_string', 'aaaaaaaaaaaaaaaa', 'hkdf', 'salt', 'info'), 'my_key_string', 'aaaaaaaaaaaaaaaa', 'hkdf', 'salt', 'info');
