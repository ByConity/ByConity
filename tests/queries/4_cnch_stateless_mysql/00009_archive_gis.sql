...
CREATE TABLE gis_point  (fid INTEGER PRIMARY KEY, g Point);
CREATE TABLE gis_line  (fid INTEGER PRIMARY KEY, g LINESTRING);
CREATE TABLE gis_polygon   (fid INTEGER PRIMARY KEY, g POLYGON);
CREATE TABLE gis_multi_point (fid INTEGER PRIMARY KEY, g MULTIPOINT);
CREATE TABLE gis_multi_line (fid INTEGER PRIMARY KEY, g MULTILINESTRING);
CREATE TABLE gis_multi_polygon  (fid INTEGER PRIMARY KEY, g MULTIPOLYGON);
CREATE TABLE gis_geometrycollection  (fid INTEGER PRIMARY KEY, g GEOMETRYCOLLECTION);
CREATE TABLE gis_geometry (fid INTEGER PRIMARY KEY, g GEOMETRY);
...
create table t1 (pk integer primary key, a geometry not null);
...
create table t1 (pk integer primary key, fl geometry not null);
--error 1416
