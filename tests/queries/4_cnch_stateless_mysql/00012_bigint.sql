...
select cast(9223372036854775808 as UInt64)+1;
...
select cast(10000002383263201056 as UInt64) mod 50 as result;
...
select cast(19999999999999999999 as Int64);
select cast(-19999999999999999999 as Int64);
...
--echo -- # Bug-- #72046 UNSIGNED BIGINT high values
--echo -- #           wrong numerical comparison results
...
--echo -- #
--echo -- # Bug-- #22501606 SELECT CAST(100 AS UNSIGNED) BETWEEN 1 AND -1 RETURNS TRUE
--echo -- # Bug-- #79857 select cast(100 as unsigned) between 1 and -1 returns true
--echo -- #

SELECT CAST(100 AS UInt64) BETWEEN 1 AND -1;
SELECT CAST(100 AS UInt64) NOT BETWEEN 1 AND -1;

SELECT CAST(0 AS UInt64) BETWEEN 0 AND -1;
SELECT CAST(0 AS UInt64) NOT BETWEEN 0 AND -1;

--echo -- #
--echo -- # Bug -- #27691347: BETWEEN CLAUSE RETURNS INCOHERENT RESULTS COMPARING
--echo -- #                NEGATIVE VALUES

CREATE TABLE Reservation (id BIGINT UNSIGNED NOT NULL,
                          transaction_id BIGINT UNSIGNED NOT NULL DEFAULT '0',
                          KEY transaction_id_idx (transaction_id));
INSERT INTO Reservation(id, transaction_id) VALUES(1, 1);

SELECT COUNT(*) FROM Reservation WHERE transaction_id BETWEEN -2 AND -1;
