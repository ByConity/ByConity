...
--echo #
--echo # Bug #27422376: NEWDATE TYPE IS LEAKING OUT
--echo #

--enable_metadata
SELECT CAST('2018-01-28 00:00:01' AS DATE) UNION
SELECT CAST('2018-01-28 00:00:01' AS DATE);

SELECT CAST('2018-01-28 00:00:01' AS DATE) UNION ALL
SELECT CAST('2018-01-28 00:00:01' AS DATE);
--disable_metadata
