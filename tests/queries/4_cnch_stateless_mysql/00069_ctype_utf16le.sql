...
INSERT INTO t1 VALUES ('0xF2', '0xF2'), ('2004', '2004');
...
--echo #
INSERT INTO t1 VALUES ('042000200020', '042000200020');
INSERT INTO t1 VALUES ('200400200020', '200400200020');
SELECT HEX(word) FROM t1 ORDER BY word;
SELECT HEX(word2) FROM t1 ORDER BY word2;
DROP TABLE t1;
...
INSERT INTO t1 VALUES ('0420', 10, '0421');
INSERT INTO t1 VALUES ('0420', 10, '04210422');
INSERT INTO t1 VALUES ('0420', 10, '042104220423');
INSERT IGNORE INTO t1 VALUES ('0420042104220423042404250426042704280429042A042B',10,'042104220423');
INSERT INTO t1 VALUES (_utf32 X'010000', 10, '0421');
INSERT INTO t1 VALUES ('0421', 10, _utf32 X'010000');
...
SELECT * FROM t1 WHERE word LIKE '00630025';     # "c%"
SELECT * FROM t1 WHERE word LIKE '00630061005F'; # "ca_"
DROP TABLE t1;
...
SELECT CHAR_LENGTH(0x00D800DC), OCTET_LENGTH(0x00D800DC);
SELECT CHAR_LENGTH(0x7DD8FFDF), OCTET_LENGTH(0x7FD8DDDF);

--echo #
--echo # Testing cs->cset->charpos()
--echo #
SELECT LEFT('abcd',2);
SELECT HEX(LEFT(0x00D800DC7FD8FFDF, 1));
SELECT HEX(RIGHT(0x00D800DC7FD8FFDF, 1));
...
INSERT INTO t1 VALUES (0x00D8);
--error ER_INVALID_CHARACTER_STRING
INSERT INTO t1 VALUES (0x00DC);
--error ER_INVALID_CHARACTER_STRING
INSERT INTO t1 VALUES (0x00D800D8);
--error ER_INVALID_CHARACTER_STRING
INSERT INTO t1 VALUES (0x00D800E8);
--error ER_INVALID_CHARACTER_STRING
INSERT INTO t1 VALUES (0x00D80008);
--echo # Good sequences
INSERT INTO t1 VALUES (0x00D800DC);
INSERT INTO t1 VALUES (0x00D8FFDC);
INSERT INTO t1 VALUES (0xFFDB00DC);
INSERT INTO t1 VALUES (0xFFDBFFDC);
SELECT HEX(a) FROM t1;
DROP TABLE t1;
...
SELECT HEX(WEIGHT_STRING(0x00D800DC));
SELECT HEX(WEIGHT_STRING(0x00D801DC));
