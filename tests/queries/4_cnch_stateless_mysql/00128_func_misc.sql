...
--echo -- #
--echo -- # Bug 33334507 - 5.7 - utf8mb4 + REPLACE(UUID(),'-','') returns duplicate UUIDs!
--echo -- #
CREATE TABLE t1(c1 CHAR(10) CHARACTER SET ascii);
INSERT INTO t1 VALUES (NULL), (NULL), (NULL);
SELECT COUNT(*) FROM t1 GROUP BY COALESCE(c1, UUID());
DROP TABLE t1;
