...
CREATE TABLE test.pk_set (d Date, n UInt64, host String, code UInt64) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(d) ORDER BY (n, host, code) SETTINGS index_granularity=1;
