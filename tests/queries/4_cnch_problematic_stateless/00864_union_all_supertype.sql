...
SET enable_optimizer = 0; -- type coercion not support yet in optimizer
...
select * from (select 'v1' as c1, null as c2 union all select 'v2' as c1, '' as c2)
ALL FULL JOIN (select 'v1' as c1, 'w1' as c2) using c1,c2 order by c1, c2;
