...
CREATE FUNCTION test_python_expression RETURNS Int64 LANGUAGE PYTHON AS
$code$
from iudf import IUDF
from overload import overload

class test_python_expression(IUDF):
    @overload
    def process(a, b, c, d):
...
SELECT
    ...
    10*test_python_expression(10*test_python_expression(col1, col2, col3, col4+col2+col3+col4), col2, col3, col4) as col6,
