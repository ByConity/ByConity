...
perform "CREATE TABLE test.alter (d Date, a Enum8('foo'=1), b DateTime, c DateTime) ENGINE=CnchMergeTree() PARTITION BY toYYYYMM(d) ORDER BY (a, b, toTime(c)) SETTINGS index_granularity = 8192"
