...
create table t_00818(a Nullable(Int64), b Nullable(Int64), c Nullable(String)) engine = CnchMergeTree order by a;
create table s_00818(a Nullable(Int64), b Nullable(Int64), c Nullable(String)) engine = CnchMergeTree order by a;
