...
CREATE TABLE IF NOT EXISTS decimal (x DECIMAL(0, 0)) ENGINE = CnchMergeTree ORDER BY x; -- { serverError 69 }
...
INSERT INTO decimal (a) VALUES ('-9x'); -- { clientError 53 }
INSERT INTO decimal (a) VALUES ('0x1'); -- { clientError 53 }
