...
CREATE TABLE test.tab (date Date, value UInt64, s String, m FixedString(16)) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY (date, value) SETTINGS index_granularity = 8;
