...
ALTER TABLE target_bucket_table INGEST PARTITION '2020-01-01'  COLUMNS name{'key1'}, name{'key2'}, name{'key3'}, name{'key4'}, name{'key5'}, name{'key6'}, name{'key7'}, name{'key8'}, name{'key9'}, name{'key10'}, name{'key11'}, name{'key12'} FROM source_bucket_table; -- { serverError 49 }
