...
create table test.test_ins_arr (date Date, val Array(UInt64)) engine = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY date SETTINGS index_granularity = 8192;
...
create table test.test_ins_null (date Date, val Nullable(UInt64)) engine = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY date SETTINGS index_granularity = 8192;
...
create table test.test_ins_arr_null (date Date, val Array(Nullable(UInt64))) engine = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY date SETTINGS index_granularity = 8192;
...
create table test.test_ins_arr_arr (date Date, val Array(Array(UInt64))) engine = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY date SETTINGS index_granularity = 8192;
...
create table test.test_ins_arr_arr_null (date Date, val Array(Array(Nullable(UInt64)))) engine = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY date SETTINGS index_granularity = 8192;
...
create table test.test_ins_arr_arr_arr (date Date, val Array(Array(Array(UInt64)))) engine = CnchMergeTree() PARTITION BY toYYYYMM(date) ORDER BY date SETTINGS index_granularity = 8192;
