...
select CAST('[\'1\', \'2\']', 'Array(String)');
select CAST('[\'1\', null]', 'Array(String)');
select CAST('[\'1\', null]', 'Array(Nullable(String))');
select CAST('[[1, 2], [1, null]]', 'Array(Nullable(Array(Int32)))');
select CAST('[[1, 2], [1, null]]', 'Array(Array(Nullable(Int32)))');
select CAST([['1', null], ['a', 'b']], 'Array(Array(Int32))');
...
select CAST(cast(pow(2, 62), 'Nullable(Decimal128(6))'), 'Decimal32(8)');
select CAST(cast(pow(2, 62), 'Nullable(Decimal128(6))'), 'Nullable(Decimal32(8))');
