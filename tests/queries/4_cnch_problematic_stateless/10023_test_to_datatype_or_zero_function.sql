...
-- test array
select cast2('[1, 2]', 'Array(Int32)');
select cast2('[1, 2]', 'Array(String)');
select cast2('[\'1\', \'2\']', 'Array(String)');
select cast2('[\'1\', null]', 'Array(String)');
select cast2('[\'1\', null]', 'Array(Nullable(String))');
select cast2('[[1, 2], [1, null]]', 'Array(Nullable(Array(Int32)))');
select cast2('[[1, 2], [1, null]]', 'Array(Array(Nullable(Int32)))');
select cast2([['1', null], ['a', 'b']], 'Array(Array(Int32))');
select cast2([['1', null], ['a', 'b']], 'Array(Array(Nullable(Int32)))');

-- test decimal convert Fail
select toDecimal32(pow(2, 62), 8); -- { serverError 407 }
select toDecimal32OrZero(pow(2, 62), 8);
select toDecimal32OrNull(pow(2, 62), 8);
select cast2(cast(pow(2, 62), 'Nullable(Decimal128(6))'), 'Decimal32(8)');
select cast2(cast(pow(2, 62), 'Nullable(Decimal128(6))'), 'Nullable(Decimal32(8))');

--
select CAST2(toDateTime('2021-06-18 08:00:00'), 'Date');
select CAST2(toDateTime('2021-06-18 08:00:00'), 'Nullable(Date)');
select CAST2(toDateTime64('2021-06-18 08:00:00.000', 3), 'Nullable(Date)');
select CAST2(toDate('2021-06-18'), 'DateTime');
select CAST2(toDate('2021-06-18'), 'Nullable(DateTime)');
select CAST2(toDate('2021-06-18'), 'Nullable(DateTime64(3, \'Europe/Moscow\'))');
select CAST2(1623974400, 'Date');
select CAST2(1623974400, 'DateTime(\'UTC\')');
select CAST2(1623974400, 'DateTime64(3, \'UTC\')');
select CAST2(1623974400000, 'Date');
select CAST2(1623974400000, 'DateTime(\'UTC\')');
select CAST2(18796, 'Date');
select CAST2(18796, 'DateTime(\'UTC\')');
select CAST2(18796, 'DateTime64(3, \'UTC\')');

--
select CAST2(-1, 'Date');
select CAST2(-1, 'DateTime(\'UTC\')');
select CAST2(-1, 'DateTime64(3, \'UTC\')');
