...
create table test.test54378 (part_date Date, pk_date Date, date Date) Engine=CnchMergeTree() PARTITION BY toYYYYMM(part_date) ORDER BY pk_date SETTINGS index_granularity=8192;
