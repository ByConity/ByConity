...
create table test.lc_prewhere (key UInt64, val UInt64, str StringWithDictionary, s String) engine = CnchMergeTree order by key settings index_granularity = 8192;
