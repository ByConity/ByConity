...
CREATE TABLE test.prewhere_defaults (d Date DEFAULT '2000-01-01', k UInt64 DEFAULT 0, x UInt16) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(d) ORDER BY k SETTINGS index_granularity=1;
