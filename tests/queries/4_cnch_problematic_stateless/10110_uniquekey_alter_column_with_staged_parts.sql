...
ALTER TABLE u10110_common DROP COLUMN k1; -- { serverError 44 }
...
ALTER TABLE u10110_common CLEAR COLUMN k2 IN PARTITION '2021-01-01'; -- { serverError 48 }
...
SELECT 'stop dedup worker and async insert one row to test next alter command';
system stop dedup worker u10110_common;
INSERT INTO u10110_common VALUES ('20210101', 'k1', 4, 'k3', 40, 4), ('20210102', 'k1', 5, 'k3', 50, 5);
SELECT '#staged parts:', count() FROM system.cnch_staged_parts where database='test' and table = 'u10110_common' and to_publish;
ALTER TABLE u10110_common MODIFY COLUMN c1 String;
...
SELECT '#staged parts:', count() FROM system.cnch_staged_parts where database='test' and table = 'u10110_common' and to_publish;
SELECT * FROM u10110_common ORDER BY d, k2;
ALTER TABLE u10110_common MODIFY COLUMN c1 Int64;
