...
CREATE TABLE t1 (str String, dec Decimal64(8)) ENGINE = CnchMergeTree ORDER BY str;
CREATE TABLE t2 (str String, dec Decimal64(8)) ENGINE = CnchMergeTree ORDER BY dec;
