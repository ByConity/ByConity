...
select count() from test_bitmap_index where arraySetCheck(int_vid, 1) and arraySetCheck(int_vid, 1) and arraySetCheck(int_vid, 1); -- 1
...
select count() from test_bitmap_index where (arraySetCheck(int_vid, 1) and arraySetCheck(int_vid, 2)) or arraySetCheck(int_vid, 2); -- 1
select count() from test_bitmap_index where (arraySetCheck(int_vid, 1, int_vid, 2)) or arraySetCheck(int_vid, 2); -- 1
select count() from test_bitmap_index where (arraySetCheck(int_vid, 1, int_vid, 2)) and arraySetCheck(int_vid, 2); -- 0
select count() from test_bitmap_index where (arraySetCheck(int_vid, 1, float_vid, 1)) and arraySetCheck(int_vid, 2, float_vid, 2); -- 0
select count() from test_bitmap_index where arraySetCheck(int_vid, 1, float_vid, 1, str_vid, '1'); -- 1
...
select 'str_vid';
select count() from test_bitmap_index where arraySetCheck(str_vid, '1'); -- 1
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') or arraySetCheck(str_vid, '4'); -- 2
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(str_vid, '4'); -- 0
select count() from test_bitmap_index where arraySetCheck(str_vid, ('1','2')) or arraySetCheck(str_vid, '4'); -- 3 
select count() from test_bitmap_index where arraySetCheck(str_vid, ('1','2')) and arraySetCheck(str_vid, '4'); -- 0
select count() from test_bitmap_index where arraySetCheck(str_vid, ('1','4')) and arraySetCheck(str_vid, '4'); -- 1
select count() from test_bitmap_index where (arraySetCheck(str_vid, ('1','2')) or arraySetCheck(str_vid, '3')) and arraySetCheck(str_vid, '4'); -- 0
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(ext, 1); -- 1
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(ext, 1) and id = 1; -- 1 
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(str_vid, ('1', '2')) and arraySetCheck(ext, 1) and id = 1; -- 1
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and id = 1; -- 1
select count() from test_bitmap_index where not arraySetCheck(str_vid, '1') and id = 1; -- 0
select count() from test_bitmap_index where not arraySetCheck(str_vid, '1'); -- 4
select count() from test_bitmap_index where not arraySetCheck(str_vid, '1') and not arraySetCheck(str_vid, '2'); -- 3
select count() from test_bitmap_index where not (arraySetCheck(str_vid, '1') or arraySetCheck(str_vid, '2')); -- 4
select count() from test_bitmap_index where not ((arraySetCheck(str_vid, '1') or arraySetCheck(str_vid, '2')) and arraySetCheck(str_vid, '3')); -- 1

select 'mix_vid';
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(float_vid, 4); -- 0
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(float_vid, 1) and arraySetCheck(ext, 1); -- 1
select count() from test_bitmap_index where arraySetCheck(str_vid, ('1','2')) or arraySetCheck(float_vid, 4); -- 3
select count() from test_bitmap_index where arraySetCheck(str_vid, ('1','2')) and arraySetCheck(float_vid, 4); -- 0
select count() from test_bitmap_index where arraySetCheck(str_vid, ('1','4')) and arraySetCheck(float_vid, 4); -- 1
select count() from test_bitmap_index where (arraySetCheck(str_vid, ('1','2')) or arraySetCheck(str_vid, '3')) and arraySetCheck(float_vid, 4); -- 0
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(float_vid, 1); -- 1
select count() from test_bitmap_index where arraySetCheck(str_vid, '1') and arraySetCheck(float_vid, 1) and id = 1; -- 1
select count() from test_bitmap_index where not arraySetCheck(str_vid, '1') and not arraySetCheck(float_vid, 2); -- 3
select count() from test_bitmap_index where not (arraySetCheck(str_vid, '1') and arraySetCheck(float_vid, 2)); -- 4
select count() from test_bitmap_index where not ((arraySetCheck(str_vid, '1') or arraySetCheck(str_vid, '2')) and arraySetCheck(float_vid, 3)); -- 1
...
select count() from test_bitmap_index where arraySetCheck(int_vid, 1) and arraySetCheck(int_vid, 1) and arraySetCheck(float_vid, 1); -- 1
