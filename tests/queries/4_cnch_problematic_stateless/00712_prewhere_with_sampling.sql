...
create table test.tab (a UInt32, b UInt32) engine = CnchMergeTree order by b % 2 sample by b % 2;
...
CREATE TABLE test.sample_prewhere (CounterID UInt32, UserID UInt64) ENGINE = CnchMergeTree ORDER BY UserID SAMPLE BY UserID;
