...
CREATE TABLE test.left_table(APIKey Int32, SomeColumn String) ENGINE = CnchMergeTree ORDER BY tuple();

INSERT INTO test.left_table VALUES(1, 'somestr');

CREATE TABLE test.right_table(APIKey Int32, EventValueForPostback String) ENGINE = CnchMergeTree ORDER BY tuple();
