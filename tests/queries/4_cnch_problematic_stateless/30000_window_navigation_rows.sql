DROP TABLE IF EXISTS window_navigation_rows;
CREATE TABLE window_navigation_rows
(
    a UInt64,
    b String,
    c Float64
...
INSERT INTO window_navigation_rows
...
FROM window_navigation_rows
ORDER BY a, b, c;

DROP TABLE window_navigation_rows;
