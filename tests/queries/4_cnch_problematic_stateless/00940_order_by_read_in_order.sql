...
CREATE TABLE pk_order(a UInt64, b UInt64, c UInt64, d UInt64) ENGINE=CnchMergeTree
ORDER BY (a, b);
...
CREATE TABLE pk_order (d DateTime, a Int32, b Int32) ENGINE = CnchMergeTree ORDER BY (d, a)
...
DROP TABLE pk_order;
CREATE TABLE pk_order (a Int, b Int) ENGINE = CnchMergeTree ORDER BY (a / b);
