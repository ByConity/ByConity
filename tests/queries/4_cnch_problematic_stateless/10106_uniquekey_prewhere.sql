...
CREATE TABLE test.unique_prewhere (id Int32, s String, m1 Int32) ENGINE = CnchMergeTree ORDER BY id UNIQUE KEY id;
...
CREATE TABLE test.unique_prewhere_large (id Int32, val Int32, granule Int32) ENGINE = CnchMergeTree ORDER BY id UNIQUE KEY id SETTINGS index_granularity=8192;
...
create table test.unique_prewhere_3 (c1 Int64, c2 Int64, c3 String) ENGINE=CnchMergeTree order by c1 unique key c1 SETTINGS index_granularity=4;
