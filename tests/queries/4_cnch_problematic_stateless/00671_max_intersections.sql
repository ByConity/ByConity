...
CREATE TABLE test1_00671(start Integer, end Integer) engine = CnchMergeTree ORDER BY start;
CREATE TABLE test2_00671(start Integer, end Integer) engine = CnchMergeTree ORDER BY start;
