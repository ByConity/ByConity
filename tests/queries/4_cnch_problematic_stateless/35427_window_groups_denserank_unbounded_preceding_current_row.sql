...
select DENSE_RANK() over (partition by a order by b groups BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) FROM  test.groups_denserank_unbounded_preceding_current_row order by a;
