...
CREATE TABLE window_navigation(`x` UInt64, `y` UInt64, `arr` Array(Float64),`fl` Float64, `dt` DateTime('UTC'), `cat` String)
    ENGINE = CnchMergeTree() 
    ORDER BY `x`
    SETTINGS index_granularity = 8192;

INSERT INTO window_navigation values (1, 3, [3,4], 0.65, '2019-01-02 00:00:00', 'aa'), (1, 4, [4,4], 0.66, '2019-01-03 00:00:00', 'bb'), (2, 3, [1,4,5], 0.69, '2019-01-12 00:00:00', 'cc'), (2, 5, [3,4], 0.611, '2019-11-02 00:00:00', 'aa'), (1, 2, [1,2], 0.64, '2019-01-01 00:00:00', 'aaaaaa');
