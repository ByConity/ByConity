...
create table rate_test (timestamp UInt32, event UInt32) Engine = CnchMergeTree ORDER BY tuple();
...
create table rate_test2 (uid UInt32 default 1,timestamp DateTime, event UInt32) Engine = CnchMergeTree ORDER BY tuple();
