...
CREATE TABLE bad_arrays (a Array(String), b Array(UInt8)) ENGINE = CnchMergeTree ORDER BY a;
INSERT INTO bad_arrays VALUES ([''],[]),([''],[1]);
SELECT a FROM bad_arrays ARRAY JOIN b;
DROP TABLE bad_arrays;
DROP TABLE IF EXISTS bad_arrays;
CREATE TABLE bad_arrays (a Array(String), b Array(String)) ENGINE = CnchMergeTree ORDER BY a;
