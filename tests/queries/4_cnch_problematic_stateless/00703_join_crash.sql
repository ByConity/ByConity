...
create table test.tab1 (a1 Int32, b1 Int32) engine = CnchMergeTree order by a1;
create table test.tab1_copy (a1 Int32, b1 Int32) engine = CnchMergeTree order by a1;
