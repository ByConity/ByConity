SET enable_optimizer = 0; -- subquery in optimizer can not execute first.
USE test;
DROP TABLE IF EXISTS test.merge_tree_in_subqueries;
CREATE TABLE test.merge_tree_in_subqueries (id UInt64, name String, num UInt64) ENGINE = CnchMergeTree ORDER BY (id, name);
