DROP TABLE IF EXISTS window_nested_aggregation;
CREATE TABLE window_nested_aggregation
(
    a UInt64,
    b String,
    c Float64
...
INSERT INTO window_nested_aggregation
...
FROM window_nested_aggregation
GROUP BY a, b
ORDER BY a, b;
DROP TABLE window_nested_aggregation;
