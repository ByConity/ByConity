...
CREATE TABLE test.sample (d Date DEFAULT '2000-01-01', x UInt16) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(d) SAMPLE BY x ORDER BY x SETTINGS index_granularity = 10;
