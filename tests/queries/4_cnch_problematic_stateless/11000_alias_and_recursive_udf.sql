...
CREATE FUNCTION lambda_recursive_udf_sum AS (x, y) -> lambda_recursive_udf_sum(x,y) + y;  -- { serverError 600 }

select py_script_2(number) as col_alias_test from numbers(10) FORMAT TabSeparatedWithNames;
