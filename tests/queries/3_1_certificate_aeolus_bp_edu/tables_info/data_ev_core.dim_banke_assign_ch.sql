...
CREATE TABLE data_ev_core.dim_banke_assign_ch (`date` Date ,`assign_id` Int8 ,`banke_id` Int64 ,`assign_name` String ) ENGINE = MergeTree() PARTITION BY date ORDER BY (banke_id,assign_id,intHash64(banke_id)) SAMPLE BY intHash64(banke_id);
