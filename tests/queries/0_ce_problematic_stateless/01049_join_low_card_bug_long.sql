...
CREATE TABLE l (x UInt32, lc String) ENGINE = CnchMergeTree order by tuple();
CREATE TABLE r (x UInt32, lc String) ENGINE = CnchMergeTree order by tuple();
CREATE TABLE nl (x Nullable(UInt32), lc Nullable(String)) ENGINE = CnchMergeTree order by tuple();
CREATE TABLE nr (x Nullable(UInt32), lc Nullable(String)) ENGINE = CnchMergeTree order by tuple();
CREATE TABLE l_lc (x UInt32, lc LowCardinality(String)) ENGINE = CnchMergeTree order by tuple();
CREATE TABLE r_lc (x UInt32, lc LowCardinality(String)) ENGINE = CnchMergeTree order by tuple();
