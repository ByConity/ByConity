...
DROP TABLE IF EXISTS test.wfnav1;
CREATE TABLE test.wfnav1 (`a` Int64, `b` Int64) ENGINE = Memory;

INSERT INTO test.wfnav1 values (1,1)(1,2)(1,4)(2,4)(2,4)(2,4)(2,4)(2,4)(2,4)(2,4)(2,4)(2,5)(3,3)(4,4)(4,8);
