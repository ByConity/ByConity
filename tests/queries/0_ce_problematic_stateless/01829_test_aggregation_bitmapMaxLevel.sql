...
create table test.test_data (tag String, uids BitMap64) Engine=MergeTree order by tag;
...
create table test.test_data (level Int32, uids BitMap64) Engine=MergeTree order by level;
