...
select 'multiple-prewhere', id, s, m1 from test.unique_prewhere prewhere s='BJ' or s='SH' where m1 >= 20 and m1 < 100;
...
CREATE TABLE test.unique_prewhere_4 (id Int32, k Int32, v Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/unique_prewhere_4', 'r1') ORDER BY id UNIQUE KEY id;
...
SELECT 'after delete', id, k, v FROM test.unique_prewhere_4 prewhere k=2 ORDER BY id;
