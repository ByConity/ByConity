...
select dense_rank() over (partition by a order by b RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) FROM test.range_denserank_unbouned_preceding_unbounded_following;
