...
select toUInt32(toTimeType('05:00:00.555')); -- { serverError 42 }
...
select toInt32(toTimeType('05:00:00.555')); -- { serverError 42 }

select toInt64(toTimeType('05:00:00', 5));
select toInt64(toTimeType('05:00:00.555', 5));
select toInt64(toTimeType('05:00:00.555')); -- { serverError 42 }

select toFloat64(toTimeType('05:00:00.555', 5));
select toFloat32(toTimeType('05:00:00.555', 5));
select toFloat32(toTimeType('05:00:00.555')); -- { serverError 42 }
