...
CREATE TABLE using2(a UInt8, b UInt8) ENGINE=CnchMergeTree ORDER BY a;
...
create table persons (id String, name String) engine= CnchMergeTree order by id;
create table children (id String, childName String) engine=CnchMergeTree order by id;
