...
create table tab_00650 (val UInt32, n Nested(x UInt8, y String)) engine = CnchMergeTree ORDER BY val;
...
create table tab_00650 (val UInt32, n Nested(x Nullable(UInt8), y String)) engine = CnchMergeTree ORDER BY val;
