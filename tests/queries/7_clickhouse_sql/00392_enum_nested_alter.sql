...
CREATE TABLE enum_nested_alter(d Date DEFAULT '2000-01-01', x UInt64, n Nested(a String, e Enum8('Hello' = 1), b UInt8)) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(d) ORDER BY x SETTINGS index_granularity=1;
...
ALTER TABLE enum_nested_alter MODIFY COLUMN n.e Array(Int16);
-- wait task finish
SELECT sleepEachRow(3) FROM numbers(30) FORMAT Null;
...
CREATE TABLE enum_nested_alter(n Nested(a Int16, b Enum16('Hello' = 1, 'World' = 2, 'a' = 300), c String)) Engine = CnchMergeTree() ORDER BY tuple() SETTINGS index_granularity = 1;
INSERT INTO enum_nested_alter VALUES ([1, 2], ['Hello', 'World'], ['Hello', 'World']), ([1, 2], ['Hello', 'a'], ['World', 'a']);

ALTER TABLE enum_nested_alter MODIFY COLUMN n.a Array(Enum16('Hello' = 1, 'World' = 2, 'a' = 300));
ALTER TABLE enum_nested_alter MODIFY COLUMN n.b Array(String);
ALTER TABLE enum_nested_alter MODIFY COLUMN n.c Array(Enum16('Hello' = 1, 'World' = 2, 'a' = 300));

SELECT toTypeName(n.a), toTypeName(n.b), toTypeName(n.c) FROM enum_nested_alter LIMIT 1;
SELECT * FROM enum_nested_alter;
...
DROP TABLE IF EXISTS enum_nested_alter;
CREATE TABLE enum_nested_alter(d Date DEFAULT '2000-01-01', x UInt64, n Nested(a String, e Enum8('Hello.world' = 1), b UInt8)) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(d) ORDER BY x SETTINGS index_granularity = 1;
