...
CREATE TABLE A(k UInt32, t DateTime, a Float64) ENGINE = CnchMergeTree() ORDER BY (k, t);
...
CREATE TABLE B(k UInt32, t DateTime, b Float64) ENGINE = CnchMergeTree() ORDER BY (k, t);
