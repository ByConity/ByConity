...
CREATE TABLE md(key UInt32, t DateTime, bid Float64, ask Float64) ENGINE = CnchMergeTree() ORDER BY (key, t);
...
CREATE TABLE tv(key UInt32, t DateTime, tv Float64) ENGINE = CnchMergeTree() ORDER BY (key, t);
