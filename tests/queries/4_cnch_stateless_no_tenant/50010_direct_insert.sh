...
${CNCH_WRITE_WORKER_CLIENT} -n --query="SET prefer_cnch_catalog=1; insert into table test.events values (1, 87657, 'show', 121245, 44, 64, '2022-06-14'),(2, 252234 , 'send', 2345, 476, 64, '2022-06-14');"
${CLICKHOUSE_CLIENT} --query="insert into table test.events values (3, 234343, 'show', 121245, 44, 64, '2022-06-15');"
