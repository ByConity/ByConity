                    ...
                    (
                        ...
                        FROM
                            (
                                ...
                                FROM
                                    `test`.`tb_5cf1836f27bf9d05a5b73aee37b52c27`
                                WHERE
...
INSERT INTO `test`.tb_5cf1836f27bf9d05a5b73aee37b52c27(p_date, base_id, tenant_dau_au_rate) VALUES ('2023-04-26', 1, 2.0);
INSERT INTO
    `test`.profile_map_tags_test_348590820934
SELECT
    *
...
SELECT base_id, double_map FROM `test`.profile_map_tags_test_348590820934;
