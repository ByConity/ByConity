...
CREATE TABLE test (a UInt8, b UInt8, c UInt16 ALIAS a + b) ENGINE = CnchMergeTree ORDER BY a SETTINGS enable_late_materialize = 1;

SELECT b FROM test WHERE c = 1;
...
FROM audience_local
WHERE Date = toDate('2019-07-25') AND Release = '17.11.0.542';
