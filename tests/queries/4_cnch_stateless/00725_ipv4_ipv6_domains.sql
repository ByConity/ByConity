...
CREATE TABLE ipv4_test (ipv4_ IPv4) ENGINE = CnchMergeTree() ORDER BY ipv4_;
...
CREATE TABLE ipv6_test (ipv6_ IPv6) ENGINE = CnchMergeTree() ORDER BY ipv6_;
...
-- Mysql Compatibility
SELECT '0.0.0.0 is ipv4 string:                                 ', is_ipv4('0.0.0.0');
SELECT 'hello is ipv4 string:                                   ', is_ipv4('hello');
SELECT '0:0:0:0:0:0:0:0 is ipv4 string:                         ', is_ipv4('0:0:0:0:0:0:0:0');
