...
create table test.test_partition_pushdown_5489 (p_date Date, id Int32) engine = CnchMergeTree
partition by p_date order by id;

insert into test.test_partition_pushdown_5489 select '2023-01-01', number from numbers(10);
insert into test.test_partition_pushdown_5489 select '2023-01-02', number from numbers(10);
