...
CREATE TABLE test1 (s String) ENGINE = CnchMergeTree ORDER BY s SETTINGS index_granularity = 1;
CREATE TABLE test2 (s LowCardinality(String)) ENGINE = CnchMergeTree ORDER BY s SETTINGS index_granularity = 1;
