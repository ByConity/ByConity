...
-- no-parallel: can't provide currentDatabase(0) to SHOW COLUMNS
...
-- As CI does not have mysql installed, the aforementioned test is marked as problematic.
-- -----------------------------------------------------------------------------------

DROP TABLE IF EXISTS 02775_show_columns_called_from_clickhouse;

SET allow_suspicious_low_cardinality_types=1;
SET allow_experimental_object_type=1;
SET allow_experimental_geo_types=1;
CREATE TABLE 02775_show_columns_called_from_clickhouse
(
    i8            Int8,
    i16           Int16,
    i32           Int32,
...
SELECT 'clickhouse types';
SHOW COLUMNS FROM 02775_show_columns_called_from_clickhouse;

SET dialect_type='MYSQL';
SELECT 'mysql types';
SHOW COLUMNS FROM 02775_show_columns_called_from_clickhouse;
SELECT 'mysql types mysql_map_string_to_text_in_show_columns=1';
SHOW COLUMNS FROM 02775_show_columns_called_from_clickhouse SETTINGS mysql_map_string_to_text_in_show_columns=1;
SELECT 'mysql types mysql_map_fixed_string_to_text_in_show_columns=1';
SHOW COLUMNS FROM 02775_show_columns_called_from_clickhouse SETTINGS mysql_map_fixed_string_to_text_in_show_columns=1;

DROP TABLE 02775_show_columns_called_from_clickhouse;
