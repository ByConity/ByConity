...
BACKUP TABLE table_backup_03100 TO DISK('hdfs_disk', 'test_backup_03100/') SETTINGS async = 0, id = 'backup_task_03100';
RESTORE TABLE table_backup_03100 AS table_restore_03100 FROM DISK('hdfs_disk', 'test_backup_03100/') SETTINGS async=0, id = 'restore_task_03100';
...
BACKUP TABLE unique_backup_03101 TO DISK('hdfs_disk', 'test_backup_03101/') SETTINGS async = 0, id = 'backup_task_03101';
RESTORE TABLE unique_backup_03101 AS unique_restore_03101 FROM DISK('hdfs_disk', 'test_backup_03101/') SETTINGS async=0, id = 'restore_task_03101';
...
BACKUP TABLE partition_backup_03102 PARTITIONS '1' TO DISK('hdfs_disk', 'test_backup_03102/') SETTINGS async = 0, id = 'backup_task_03102';
RESTORE TABLE partition_backup_03102 AS partition_restore_03102 PARTITIONS '1' FROM DISK('hdfs_disk', 'test_backup_03102/') SETTINGS async=0, id = 'restore_task_03102';
...
BACKUP DATABASE database_backup_03103 TO DISK('hdfs_disk', 'test_backup_03103/') SETTINGS async = 0, id = 'backup_task_03103';
RESTORE DATABASE database_backup_03103 AS database_restore_03103 FROM DISK('hdfs_disk', 'test_backup_03103/') SETTINGS async=0, id = 'restore_task_03103';
...
BACKUP DATABASE database_backup_03104 EXCEPT TABLES unique_backup TO DISK('hdfs_disk', 'test_backup_03104/') SETTINGS async = 0, id = 'backup_task_03104';
RESTORE DATABASE database_backup_03104 AS database_restore_03104 FROM DISK('hdfs_disk', 'test_backup_03104/') SETTINGS async=0, id = 'restore_task_03104';
