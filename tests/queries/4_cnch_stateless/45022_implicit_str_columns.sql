...
create table t(id UInt64, params Map(String, String)) ENGINE=CnchMergeTree() order by id;
...
insert into t select number, map('a', toString(number * 10), 'e', toString(number * 50)) from system.numbers limit 100;
