...
CREATE TABLE array_pk (key Array(UInt8), s String, n UInt64, d Date MATERIALIZED '2000-01-01') ENGINE = CnchMergeTree PARTITION BY toMonth(d) ORDER BY (key, s, n) SETTINGS index_granularity = 1, enable_late_materialize = 1;
