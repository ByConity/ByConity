...
CREATE TABLE test_aggregation (x Array(Int)) ENGINE=CnchMergeTree() order by tuple();
...
CREATE TABLE test_aggregation (x Array(Decimal64(8))) ENGINE=CnchMergeTree() order by tuple();
