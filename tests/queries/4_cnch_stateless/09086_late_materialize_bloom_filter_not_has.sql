...
CREATE TABLE bloom_filter_null_array (v Array(Int32), INDEX idx v TYPE bloom_filter GRANULARITY 3) ENGINE = CnchMergeTree() ORDER BY v SETTINGS enable_late_materialize = 1;
