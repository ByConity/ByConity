...
create table test54378 (part_date Date, pk_date Date, date Date) Engine=CnchMergeTree partition by toMonth(part_date) order by pk_date settings enable_late_materialize = 1;
...
select 211 from test54378 where part_date = '2018-04-19';
select 212 from test54378 where part_date in ('2018-04-19');
select 213 from test54378 where pk_date in ('2018-04-19');
select 214 from test54378 where date in ('2018-04-19');
SELECT '-';
select 221 from test54378 where part_date = toDate('2018-04-19');
select 222 from test54378 where part_date in (toDate('2018-04-19'));
select 223 from test54378 where pk_date in (toDate('2018-04-19'));
select 224 from test54378 where date in (toDate('2018-04-19'));
SELECT '-';
select 231 from test54378 where part_date = (SELECT toDate('2018-04-19'));
select 232 from test54378 where part_date in (SELECT toDate('2018-04-19'));
select 233 from test54378 where pk_date in (SELECT toDate('2018-04-19'));
select 234 from test54378 where date in (SELECT toDate('2018-04-19'));
