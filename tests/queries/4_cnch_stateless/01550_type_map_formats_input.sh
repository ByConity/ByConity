...
$CLICKHOUSE_CLIENT -q "CREATE TABLE map_formats_input (m Map(String, UInt32) KV, m1 Map(String, Date) KV, m2 Map(String, Array(UInt32)) KV) ENGINE = CnchMergeTree order by tuple();" --allow_experimental_map_type 1
