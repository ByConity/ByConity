...
create table prewhere_column_missing (d Date default '2015-01-01', x UInt64) engine=CnchMergeTree PARTITION BY toMonth(d) ORDER BY x SETTINGS index_granularity = 1, enable_late_materialize = 1;
