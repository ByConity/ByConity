...
create table lc_str_0 (str LowCardinality(String)) engine = CnchMergeTree order by tuple();
create table lc_str_1 (str StringWithDictionary) engine = CnchMergeTree order by tuple();
create table lc_null_str_0 (str LowCardinality(Nullable(String))) engine = CnchMergeTree order by tuple();
create table lc_null_str_1 (str NullableWithDictionary(String)) engine = CnchMergeTree order by tuple();
create table lc_int8_0 (val LowCardinality(Int8)) engine = CnchMergeTree order by tuple();
create table lc_int8_1 (val Int8WithDictionary) engine = CnchMergeTree order by tuple();
create table lc_null_int8_0 (val LowCardinality(Nullable(Int8))) engine = CnchMergeTree order by tuple();
create table lc_null_int8_1 (val NullableWithDictionary(Int8)) engine = CnchMergeTree order by tuple();
create table lc_fix_str_0 (str LowCardinality(FixedString(2))) engine = CnchMergeTree order by tuple();
create table lc_fix_str_1 (str FixedStringWithDictionary(2)) engine = CnchMergeTree order by tuple();
create table lc_null_fix_str_0 (str LowCardinality(Nullable(FixedString(2)))) engine = CnchMergeTree order by tuple();
create table lc_null_fix_str_1 (str NullableWithDictionary(FixedString(2))) engine = CnchMergeTree order by tuple();
...
create table lc_str_uuid(str1 String, str2 LowCardinality(String), str3 StringWithDictionary) ENGINE = CnchMergeTree order by tuple();
