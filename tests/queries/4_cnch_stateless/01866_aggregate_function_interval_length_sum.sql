...
CREATE TABLE interval ( `id` String, `start` Int64, `end` Int64 ) ENGINE = CnchMergeTree ORDER BY start;
INSERT INTO interval VALUES ('a', 1, 3), ('a', 1, 3), ('a', 2, 4), ('a', 1, 1), ('a', 5, 6), ('a', 5, 7), ('b', 10, 12), ('b', 13, 19), ('b', 14, 16), ('c', -1, 1), ('c', -2, -1);

CREATE TABLE fl_interval ( `id` String, `start` Float, `end` Float ) ENGINE = CnchMergeTree ORDER BY start;
INSERT INTO fl_interval VALUES ('a', 1.1, 3.2), ('a', 1.5, 3.6), ('a', 4.0, 5.0);

CREATE TABLE dt_interval ( `id` String, `start` DateTime, `end` DateTime ) ENGINE = CnchMergeTree ORDER BY start;
INSERT INTO dt_interval VALUES ('a', '2020-01-01 02:11:22', '2020-01-01 03:12:31'), ('a', '2020-01-01 01:12:30', '2020-01-01 02:50:11');

CREATE TABLE date_interval ( `id` String, `start` Date, `end` Date ) ENGINE = CnchMergeTree ORDER BY start;
