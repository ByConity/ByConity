...
CREATE TABLE test_tuple (value Tuple(UInt8, UInt8)) ENGINE=CnchMergeTree ORDER BY tuple();
...
CREATE TABLE test_tuple_nested_in_array (value Array(Tuple(UInt8, UInt8))) ENGINE=CnchMergeTree ORDER BY tuple();
...
CREATE TABLE test_tuple_nested_in_array_nested_in_tuple (value Tuple(UInt8, Array(Tuple(UInt8, UInt8)))) ENGINE=CnchMergeTree ORDER BY tuple();
...
CREATE TABLE test_tuple_nested_in_map (value Map(String, Tuple(UInt8, UInt8)) KV) ENGINE=CnchMergeTree ORDER BY tuple();
