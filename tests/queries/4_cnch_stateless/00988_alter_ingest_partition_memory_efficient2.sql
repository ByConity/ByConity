...
INSERT INTO test_ingest_partition_source VALUES ('2010-01-01', 1, 2, 'a', 'b'), ('2010-01-01', 3, 4, 'a', 'b');
INSERT INTO test_ingest_partition_source VALUES ('2010-01-01', 2, 2, 'a', 'b'), ('2010-01-01', 2, 3, 'a', 'b');

SELECT 'SOURCE';
SELECT * FROM test_ingest_partition_source ORDER BY id1, id2;

INSERT INTO test_ingest_partition_target VALUES ('2010-01-01', 1, 2, 'c', 'd', 'e'), ('2010-01-01', 3, 4, 'c', 'd', 'e'), ('2010-01-01', 2, 2, 'c', 'd', 'e'), ('2010-01-01', 2, 3, 'c', 'd', 'e');
SELECT 'TARGET';
