...
CREATE TABLE test_table (value UInt8, name String) ENGINE = CnchMergeTree() ORDER BY value;
...
CREATE TABLE test_table (v1 String, v2 UInt8, v3 DEFAULT v2 * 16, v4 UInt8 DEFAULT 8) ENGINE = CnchMergeTree() ORDER BY v2;
...
SELECT 7;
/* Check Nested */
CREATE TABLE test_table_2 (v1 UInt8, n Nested(id UInt8, name String)) ENGINE = CnchMergeTree() ORDER BY v1;
