...
CREATE TABLE test1_00671(start Integer, end Integer) ENGINE = CnchMergeTree() ORDER BY tuple();
CREATE TABLE test2_00671(start Integer, end Integer) ENGINE = CnchMergeTree() ORDER BY tuple();
