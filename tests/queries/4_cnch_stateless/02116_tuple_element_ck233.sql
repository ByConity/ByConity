...
CREATE TABLE t_tuple_element(t1 Tuple(a UInt32, s String), t2 Tuple(UInt32, String)) ENGINE = CnchMergeTree() ORDER BY tuple();
...
SELECT tupleElement(t1, 0) FROM t_tuple_element; -- { serverError 10 }
SELECT tupleElement(t1, 3) FROM t_tuple_element; -- { serverError 10 }
...
SELECT tupleElement(t2, 0) FROM t_tuple_element; -- { serverError 10 }
SELECT tupleElement(t2, 3) FROM t_tuple_element; -- { serverError 10 }
