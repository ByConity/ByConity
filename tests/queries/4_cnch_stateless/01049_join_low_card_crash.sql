...
CREATE TABLE Alpha (foo String, bar UInt64) ENGINE = CnchMergeTree order by tuple();
CREATE TABLE Beta (foo LowCardinality(String), baz UInt64) ENGINE = CnchMergeTree order by tuple();
