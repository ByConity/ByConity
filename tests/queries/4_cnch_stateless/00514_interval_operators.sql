...
SELECT toDateTime('2017-10-30 08:18:19') + INTERVAL '1-12' YEAR_MONTH;
SELECT toDateTime('2017-10-30 08:18:19') - INTERVAL '1-12' YEAR_MONTH;
SELECT toDateTime('2017-10-30 08:18:19') + INTERVAL '1 10:10:10' DAY_TIME;
SELECT toDateTime('2017-10-30 08:18:19') - INTERVAL '1 10:10:10' DAY_TIME;

SELECT toDateTime('2017-10-30 08:18:19') + INTERVAL 1 DAY + INTERVAL '1-12' YEAR_MONTH + INTERVAL '1 0:0:0' DAY_TIME;
