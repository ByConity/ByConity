...
SYSTEM STOP MERGES test_ingest_partition_source;
...
INSERT INTO test_ingest_partition_source VALUES ('2020-01-01', 1, {'key1': 's1', 'key2': 's2', 'key3': 's3'}), ('2020-01-01', 4, {'key1': 's1', 'key2': 's2', 'key3': 's3'});
INSERT INTO test_ingest_partition_source VALUES ('2020-01-01', 2, {'key1': 's1', 'key2': 's2', 'key3': 's3'}), ('2020-01-01', 3, {'key1': 's1', 'key2': 's2', 'key3': 's3'});
SELECT 'SOURCE';
SELECT * from test_ingest_partition_source ORDER BY id;
SELECT 'TARGET';
INSERT INTO test_ingest_partition_target VALUES ('2020-01-01', 1, {'key1': 't1', 'key2': 't2', 'key3': 't3'}), ('2020-01-01', 2, {'key1': 't1', 'key2': 't2', 'key3': 't3'}), ('2020-01-01', 3, {'key1': 't1', 'key2': 't2', 'key3': 't3'}), ('2020-01-01', 4, {'key1': 't1', 'key2': 't2', 'key3': 't3'});
