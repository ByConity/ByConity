...
CREATE TABLE table_map_with_key_integer (d DATE, m Map(Int8, Int8) KV)
ENGINE = CnchMergeTree ORDER BY d;
...
CREATE TABLE table_map_with_key_integer (d DATE, m Map(Int32, UInt16) KV)
ENGINE = CnchMergeTree ORDER BY d;
...
CREATE TABLE table_map_with_key_integer (d DATE, m Map(Date, Int32) KV)
ENGINE = CnchMergeTree ORDER BY d;
...
CREATE TABLE table_map_with_key_integer (d DATE, m Map(UUID, UInt16) KV)
ENGINE = CnchMergeTree ORDER BY d;
...
CREATE TABLE table_map_with_key_integer (d DATE, m Map(Int128, String) KV)
ENGINE = CnchMergeTree ORDER BY d;
...
CREATE TABLE table_map_with_key_integer (m Map(Nullable(String), String)) ENGINE = CnchMergeTree ORDER BY tuple(); -- { serverError 36}
CREATE TABLE table_map_with_key_integer (m Map(Array(UInt32), String)) ENGINE = CnchMergeTree ORDER BY tuple(); -- { serverError 36}
