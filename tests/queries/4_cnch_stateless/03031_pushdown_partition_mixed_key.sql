...
create table test.test_partition_pushdown_5489234 (p_date Date, app_id Int32, id Int32) engine = CnchMergeTree
partition by (p_date, app_id) order by id;

insert into test.test_partition_pushdown_5489234 select '2023-01-01', 1, number from numbers(10);
insert into test.test_partition_pushdown_5489234 select '2023-01-02', 2, number from numbers(10);
