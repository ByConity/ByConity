...
RAW_URL=`echo "${RAW_URL}" | sed "s@bsp_mode=0&@@g"`
RAW_URL=`echo "${RAW_URL}" | sed "s@bsp_mode=1&@@g"`
RAW_URL=`echo "${RAW_URL}" | sed "s@enable_runtime_filter=0&@@g"`
RAW_URL=`echo "${RAW_URL}" | sed "s@enable_runtime_filter=1&@@g"`
RAW_URL=`echo "${RAW_URL}" | sed "s@cte_mode=INLINED&@@g"`
