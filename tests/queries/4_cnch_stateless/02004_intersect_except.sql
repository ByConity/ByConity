...
SELECT toString(number) FROM numbers(10) INTERSECT DISTINCT SELECT toString(number) FROM numbers(5);
...
SELECT '-- EXCEPT --';
SELECT number FROM numbers(10) EXCEPT DISTINCT SELECT number FROM numbers(5);
SELECT toString(number) FROM numbers(10) EXCEPT DISTINCT SELECT toString(number) FROM numbers(5);
SELECT 1 FROM numbers(10) EXCEPT DISTINCT SELECT 2 FROM numbers(10);
SELECT '1' FROM numbers(10) EXCEPT DISTINCT SELECT '2' FROM numbers(10);
SELECT toString(1) FROM numbers(10) EXCEPT DISTINCT SELECT toString(2) FROM numbers(10);
