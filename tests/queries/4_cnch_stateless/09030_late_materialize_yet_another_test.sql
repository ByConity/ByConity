...
create table t50 (a Int, b Int, s String) engine = CnchMergeTree order by a settings index_granularity = 50, index_granularity_bytes=1000, min_index_granularity_bytes=500, enable_late_materialize = 1;
...
select a, b from t50 where b = 1 order by a;
