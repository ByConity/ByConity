...
CREATE TABLE insert (i UInt64, s String, u UUID, d Date, t DateTime, a Array(UInt32)) 
ENGINE = CnchMergeTree ORDER BY i;
...
create table if not exists t_306 (a int) engine = CnchMergeTree ORDER BY a;
