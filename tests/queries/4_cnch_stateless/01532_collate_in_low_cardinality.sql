...
CREATE TABLE test_collate (x UInt32, s LowCardinality(String)) ENGINE=CnchMergeTree() order by tuple();
CREATE TABLE test_collate_null (x UInt32, s LowCardinality(Nullable(String))) ENGINE=CnchMergeTree() order by tuple();
