...
CREATE TABLE `$4@^7` (c String) ENGINE = CnchMergeTree() ORDER BY c;
SHOW COLUMNS FROM `$4@^7`;
DROP TABLE `$4@^7`;

DROP TABLE IF EXISTS NULL;
CREATE TABLE NULL (c String) ENGINE = CnchMergeTree() ORDER BY c;
SHOW COLUMNS FROM NULL;
DROP TABLE NULL;

DROP DATABASE IF EXISTS `'`;
CREATE DATABASE `'`;
CREATE TABLE `'`.`'` (c String) ENGINE = CnchMergeTree() ORDER BY c;
