...
create table tbl(dt DateTime, i int, j String, v Float64) engine CnchMergeTree partition by (toDate(dt), i % 2, length(j)) order by i settings index_granularity = 1;
...
create table tbl2(i int) engine CnchMergeTree order by i;
