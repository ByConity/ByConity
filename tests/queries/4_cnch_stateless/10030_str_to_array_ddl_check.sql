...
CREATE TABLE IF NOT EXISTS test_cnch_ddl_check_db1.tb1(d Date, id UInt64, a String, c Int64)
...
alter table test_cnch_ddl_check_db1.tb1 modify column c UInt64;
