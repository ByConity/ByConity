...
CREATE TABLE collate_test1 (x UInt32, s Array(String)) ENGINE=CnchMergeTree() order by tuple();
CREATE TABLE collate_test2 (x UInt32, s Array(LowCardinality(Nullable(String)))) ENGINE=CnchMergeTree() order by tuple();
CREATE TABLE collate_test3 (x UInt32, s Array(Array(String))) ENGINE=CnchMergeTree() order by tuple();
