...
CREATE TABLE collate_test1 (x UInt32, s Tuple(UInt32, String)) ENGINE=CnchMergeTree() order by tuple();
CREATE TABLE collate_test2 (x UInt32, s Tuple(UInt32, LowCardinality(Nullable(String)))) ENGINE=CnchMergeTree() order by tuple();
CREATE TABLE collate_test3 (x UInt32, s Tuple(UInt32, Tuple(UInt32, Array(String)))) ENGINE=CnchMergeTree() order by tuple();
