...
create table mapop_test (a UInt32, m Map(UInt64, Int32)) engine=CnchMergeTree order by a;
insert into mapop_test (a, m) select number, map(1, toInt32(2), number, 2) from numbers(1, 10);
