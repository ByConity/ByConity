...
CREATE TABLE test_degs_to_rads (degrees Float64) ENGINE = CnchMergeTree() ORDER BY degrees;
...
CREATE TABLE test_rads_to_degs (radians Float64) ENGINE = CnchMergeTree() ORDER BY radians;
