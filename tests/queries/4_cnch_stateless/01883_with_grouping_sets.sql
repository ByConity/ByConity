...
CREATE TABLE grouping_sets(fact_1_id Int32, fact_2_id Int32, fact_3_id Int32, fact_4_id Int32, sales_value Int32) ENGINE = CnchMergeTree() ORDER BY tuple();
...
ORDER BY fact_1_id, fact_3_id; -- { serverError 48 }
