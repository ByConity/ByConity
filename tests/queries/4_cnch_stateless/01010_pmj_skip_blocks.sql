...
CREATE TABLE t0 (x UInt32, y UInt64) engine = CnchMergeTree ORDER BY (x,y);
CREATE TABLE t1 (x UInt32, y UInt64) engine = CnchMergeTree ORDER BY (x,y);
CREATE TABLE t2 (x UInt32, y UInt64) engine = CnchMergeTree ORDER BY (x,y);
