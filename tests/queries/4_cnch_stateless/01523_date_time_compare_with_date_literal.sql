...
CREATE TABLE test(timestamp DateTime) ENGINE = CnchMergeTree ORDER BY timestamp;
...
DROP TABLE test;
CREATE TABLE test(timestamp DateTime64) ENGINE = CnchMergeTree ORDER BY timestamp;
