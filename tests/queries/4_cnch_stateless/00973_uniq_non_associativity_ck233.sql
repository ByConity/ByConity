 ...
 */
CREATE TABLE part_a ENGINE = CnchMergeTree() ORDER BY tuple() AS SELECT * FROM
(
WITH
    number AS k1,
 ...
 */
CREATE TABLE part_b ENGINE = CnchMergeTree() ORDER BY tuple() AS SELECT * FROM
(
WITH
    number AS k1,
    bitXor(k1, bitShiftRight(k1, 33)) AS k2,
 ...
 * a + c: [               aaaaaaaaaaacc]
 */
CREATE TABLE part_c ENGINE = CnchMergeTree() ORDER BY tuple() AS SELECT * FROM
(
WITH
    number AS k1,
    bitXor(k1, bitShiftRight(k1, 33)) AS k2,
 ...
 * a+c+d: [dd             aaaaaaaaaaacc]
  */
CREATE TABLE part_d ENGINE = CnchMergeTree() ORDER BY tuple() AS SELECT * FROM
(
WITH
    number AS k1,
    bitXor(k1, bitShiftRight(k1, 33)) AS k2,
