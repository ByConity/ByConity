...
SELECT count() FROM system.mutations WHERE database = currentDatabase() and table = 't_mutations_basic_info' LIMIT 1 SETTINGS system_mutations_only_basic_info = 1;
