...
SET max_memory_usage = 685000000;
...
CREATE TABLE t_00284_str(s String) ENGINE = CnchMergeTree() ORDER BY tuple();
...
CREATE TABLE t_00284_lc_str(s LowCardinality(String)) ENGINE = CnchMergeTree() ORDER BY tuple();
