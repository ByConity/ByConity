...
SELECT * FROM test.bucket_user_expression2 b LEFT JOIN test.normal n ON b.d=n.b ORDER BY d;
SELECT * FROM test.bucket_user_expression2 b RIGHT JOIN test.normal n ON b.d=n.b ORDER BY b;
SELECT 'sipHash';
...
explain SELECT * FROM test.bucket_dtspartition b LEFT JOIN test.bucket_dtspartition_bucket_2 n ON b.d=n.d;
