...
CREATE TABLE test_datetime(timestamp DateTime('Asia/Istanbul')) ENGINE=CnchMergeTree ORDER BY timestamp;
...
CREATE TABLE test_datetime(timestamp DateTime64(3, 'Asia/Istanbul')) Engine=CnchMergeTree ORDER BY timestamp;
