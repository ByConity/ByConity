...
drop table if exists test.t11012;
create table test.t11012(i Int32, m Map(String, Int32)) engine = CnchMergeTree() order by tuple();
insert into test.t11012 values (1, {'foo': 1});

select cast(m, 'Map(String, Int64)') from test.t11012;
select cast(m, 'Map(String, String)') from test.t11012;
select cast(m, 'Map(String, Float32)') from test.t11012;
