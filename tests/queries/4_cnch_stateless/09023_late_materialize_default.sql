...
CREATE TABLE test_generic_events_all (APIKey UInt8, SessionType UInt8) ENGINE = CnchMergeTree() PARTITION BY APIKey ORDER BY tuple() SETTINGS enable_late_materialize = 1;
