...
CREATE TABLE vec1f (id UInt64, v Array(Float32)) ENGINE = CnchMergeTree() ORDER BY tuple();
CREATE TABLE vec1d (id UInt64, v Array(Float64)) ENGINE = CnchMergeTree() ORDER BY tuple();
