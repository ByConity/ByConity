...
EXPLAIN SYNTAX SELECT * FROM system.one ANY LEFT JOIN (SELECT 0 AS dummy) USING dummy WHERE 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT toUInt64(b) AS a, sum(id) AS b FROM test.push_down_predicate) WHERE a = 3;
SELECT * FROM (SELECT toUInt64(b) AS a, sum(id) AS b FROM test.push_down_predicate) WHERE a = 3;

EXPLAIN SYNTAX SELECT date, id, name, value FROM (SELECT date, name, value, min(id) AS id FROM test.push_down_predicate GROUP BY date, name, value) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT toUInt64(b) AS a, sum(id) AS b FROM test.push_down_predicate AS table_alias) AS outer_table_alias WHERE outer_table_alias.b = 3;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM test.push_down_predicate) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM (SELECT * FROM test.push_down_predicate)) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT b.* FROM (SELECT * FROM test.push_down_predicate) AS b) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT date, id, name, value FROM test.push_down_predicate) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT date, id, name, value FROM (SELECT date, id, name, value FROM test.push_down_predicate)) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM test.push_down_predicate) AS b WHERE b.id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM (SELECT * FROM test.push_down_predicate) AS a) AS b WHERE b.id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT id, date, min(value) AS value FROM test.push_down_predicate GROUP BY id, date) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM test.push_down_predicate UNION ALL SELECT * FROM test.push_down_predicate) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM test.push_down_predicate) ANY LEFT JOIN (SELECT * FROM test.push_down_predicate) USING id WHERE id = 1;
SELECT * FROM (SELECT * FROM test.push_down_predicate) ANY LEFT JOIN (SELECT * FROM test.push_down_predicate) USING id WHERE id = 1;

EXPLAIN SYNTAX SELECT * FROM (SELECT toInt8(1) AS id) ANY LEFT JOIN test.push_down_predicate USING id WHERE value = 1;
...
EXPLAIN SYNTAX SELECT b.value FROM (SELECT toInt8(1) AS id) ANY LEFT JOIN test.push_down_predicate AS b USING id WHERE value = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM (SELECT * FROM test.push_down_predicate) ANY LEFT JOIN (SELECT * FROM test.push_down_predicate) USING id) WHERE id = 1;
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM test.push_down_predicate) ANY LEFT JOIN (SELECT * FROM test.push_down_predicate) AS b USING id WHERE b.id = 1;
...
-- Compatibility test
EXPLAIN SYNTAX SELECT * FROM (SELECT toInt8(1) AS id, toDate('2000-01-01') AS date FROM system.numbers LIMIT 1) ANY LEFT JOIN (SELECT * FROM test.push_down_predicate) AS b USING date, id WHERE b.date = toDate('2000-01-01');
...
EXPLAIN SYNTAX SELECT * FROM (SELECT * FROM (SELECT * FROM test.push_down_predicate) AS a ANY LEFT JOIN (SELECT * FROM test.push_down_predicate) AS b  ON  a.id = b.id) WHERE id = 1;
