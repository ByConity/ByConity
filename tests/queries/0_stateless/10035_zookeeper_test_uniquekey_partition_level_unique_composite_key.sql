...
create table test.partition_level_unique_composite_key_r1 (d Date, id Int32, s String, revenue Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/partition_level_unique_composite_key', 'r1') partition by d order by id unique key (id, s) SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;
create table test.partition_level_unique_composite_key_r2 (d Date, id Int32, s String, revenue Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/partition_level_unique_composite_key', 'r2') partition by d order by id unique key (id, s) SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;

create table test.partition_level_unique_expression_key_r3 (d Date, id Int32, s String, revenue Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/partition_level_unique_expression_key', 'r3') partition by d order by id unique key (id, sipHash64(s)) SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;
create table test.partition_level_unique_expression_key_r4 (d Date, id Int32, s String, revenue Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/partition_level_unique_expression_key', 'r4') partition by d order by id unique key (id, sipHash64(s)) SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;
