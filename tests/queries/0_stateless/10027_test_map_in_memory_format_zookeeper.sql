...
insert into test.10027_test_map_in_memory_format_zookeeper1 values(1000, {'s1':'s_v1', 's2':'s_v2'}, {'s_l1':['l_v1', 'l_v2', 'l_v3']}, {1: 1, 2: 2}, {1:[1, 2, 3], 2:[4,5,6]});
...
select '';
select 'select id, int_params, int_params{1}, int_list_params from test.10027_test_map_in_memory_format_zookeeper1';
select id, int_params, int_params{1}, int_list_params from test.10027_test_map_in_memory_format_zookeeper1 order by id;
select '';
...
select '';
select 'select id, int_params, int_params{1}, int_list_params from test.10027_test_map_in_memory_format_zookeeper2';
select id, int_params, int_params{1}, int_list_params from test.10027_test_map_in_memory_format_zookeeper2 order by id;
select '';
...
insert into test.10027_test_map_in_memory_format_zookeeper2 values(1001, {'s3':'s_v3', 's4':'s_v4'}, {'s_l2':['l_v4', 'l_v5']}, {2: 1, 3: 3}, {3:[4, 5, 6, 7]});
