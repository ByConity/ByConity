...
insert into test.10027_test_map_in_compact_format values(1000, {'s1':'s_v1', 's2':'s_v2'}, {'s_l1':['l_v1', 'l_v2', 'l_v3']}, {'i1': 1, 'i2': 2}, {'i_l1':[1, 2, 3], 'i_l2':[4,5,6]});
...
select '';
select 'select id, int_params, int_params{\'i1\'}, int_list_params from test.10027_test_map_in_compact_format';
select id, int_params, int_params{'i1'}, int_list_params from test.10027_test_map_in_compact_format order by id;
select '';
...
insert into test.10027_test_map_in_compact_format values(1001, {'s3':'s_v3', 's4':'s_v4'}, {'s_l2':['l_v4', 'l_v5']}, {'i2': 1, 'i3': 3}, {'i_l3':[4, 5, 6, 7]});
...
insert into test.10027_test_map_in_compact_format values(1002, {'s4':'s_v3', 's5':'s_v5'}, {'s_l2':['l_2'], 's_l3': ['l_3']}, {'i4': 4}, {'i_l4':[6, 7]});
optimize table test.10027_test_map_in_compact_format final;
select '';
select 'select id, string_params, string_params{\'s1\'}, string_list_params from test.10027_test_map_in_compact_format';
select id, string_params, string_params{'s1'}, string_list_params from test.10027_test_map_in_compact_format order by id;
