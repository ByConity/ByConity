...
create table test_explain_stats_local (
    id UInt64,
    i8 Int8,
    i16 Int16,
    i32 Int32,
...
create table test_explain_stats as test_explain_stats_local engine=Distributed(test_shard_localhost, currentDatabase(), test_explain_stats_local, rand());
