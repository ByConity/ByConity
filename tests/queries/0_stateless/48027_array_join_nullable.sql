...
CREATE TABLE array_join_nullable_48027 (`hash_uid` UInt64, `data` Nullable(Array(String))) ENGINE = MergeTree() PARTITION BY cityHash64(hash_uid) ORDER BY hash_uid SETTINGS index_granularity = 8192;
