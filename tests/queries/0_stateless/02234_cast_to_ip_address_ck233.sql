...
SELECT IPv4StringToNum('test'); --{serverError 675}
...
SELECT toIPv4('test'); --{serverError 675}
...
SELECT cast('test' , 'IPv4'); --{serverError 675}
...
SELECT IPv6StringToNum('test'); --{serverError 676}
...
SELECT toIPv6('test'); --{serverError 676}
...
SELECT toIPv6('::.1.2.3'); --{serverError 676}
...
SELECT cast('test' , 'IPv6'); --{serverError 676}
