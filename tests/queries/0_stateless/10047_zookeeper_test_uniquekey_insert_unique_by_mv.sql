...
create table test.insert_unique_by_mv1 (d Date, id Int32, params Map(String, Int32))
Engine=HaUniqueMergeTree('/clickhouse/tables/test/insert_unique_by_mv', 'r1') order by id unique key id
SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;

create table test.insert_unique_by_mv2 (d Date, id Int32, params Map(String, Int32))
Engine=HaUniqueMergeTree('/clickhouse/tables/test/insert_unique_by_mv', 'r2') order by id unique key id
...
system sync replica test.insert_unique_by_mv2;
