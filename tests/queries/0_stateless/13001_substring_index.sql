...
DROP TABLE IF EXISTS test.substring_index_table;
CREATE TABLE test.substring_index_table
(
    a Nullable(String),
    b String,
    c Int64,
...
INSERT INTO test.substring_index_table (a, b, c, d) VALUES ('A#B#C', '#', 2, 1), ('', '#', 1, 2), ('A#B#C', '#', 4, 3), ('A##B#C', '#', -2, 4), ('A,B,C', '#', -1, 5), ('A##B##C', '##', -2, 6), ('###', '#', 3, 7), ('A#B#C', '#', -1, 8), (null, '#', 5, 9);
SELECT substring_index(a, b, c), d FROM test.substring_index_table ORDER BY d;
