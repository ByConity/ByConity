...
CREATE TABLE aeolus_data_table_177956_prod_local
(
    `row_id_kmtq3k` Int64,
    `p_date` Date,
...
ENGINE = MergeTree PARTITION BY p_date ORDER BY (row_id_kmtq3k, intHash64(row_id_kmtq3k));
...
ENGINE = Distributed('test_shard_localhost', currentDatabase(), 'aeolus_data_table_177956_prod_local', intHash64(row_id_kmtq3k));
