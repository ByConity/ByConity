...
select mapContains(a, 10) from table_map; -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
...
select mapContains(a, 'aaa') from table_map; -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
...
select mapFromArrays(['aa', 'bb'], [4, 5, 6]); -- { serverError SIZES_OF_ARRAYS_DOESNT_MATCH }
