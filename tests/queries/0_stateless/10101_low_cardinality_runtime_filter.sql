...
create table lc_rf1 (c1 UInt32, c2 LowCardinality(Nullable(UInt32))) engine = MergeTree order by c1;
create table lc_rf2 (c1 UInt32, c2 LowCardinality(Nullable(UInt32))) engine = MergeTree order by c1;
