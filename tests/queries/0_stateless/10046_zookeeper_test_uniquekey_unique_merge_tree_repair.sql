...
create table test.unique_repair_r1 (d Date, id Int32, m Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/unique_repair', 'r1') partition by d order by id unique key id SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;
...
create table test.unique_repair_r2 (d Date, id Int32, m Int32) ENGINE=HaUniqueMergeTree('/clickhouse/tables/test/unique_repair', 'r2') partition by d order by id unique key id SETTINGS ha_unique_update_log_sleep_ms=10, ha_unique_replay_log_sleep_ms=10;
