...
drop table if exists test_explain_stats_lc_local;
drop table if exists test_explain_stats_lc;
create table test_explain_stats_lc_local (
    id UInt64,
...
create table test_explain_stats_lc as test_explain_stats_lc_local engine=Distributed(test_shard_localhost, currentDatabase(), test_explain_stats_lc_local, rand());
