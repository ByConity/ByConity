...
select parseDateTimeInJodaSyntax('AD 1999 2000', 'G yyyy YYYY', 'UTC') = toDateTime('2000-01-01', 'UTC');
select parseDateTimeInJodaSyntax('AD 1999', 'G Y'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('AD 1999', 'G YY'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('AD 1999', 'G YYY'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('BC', 'G'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('AB', 'G'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('1969', 'YYYY', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('2107', 'YYYY', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('+1999', 'YYYY', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('1', 'YY', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('1970', 'xxxx', 'UTC'); -- { serverError 321 }
select parseDateTimeInJodaSyntax('1969', 'xxxx', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('2107', 'xxxx', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('19', 'CC', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('22', 'CC', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('0', 'M', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('13', 'M', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('12345', 'M', 'UTC'); -- { serverError 41 }
...
--- invalid month names
select parseDateTimeInJodaSyntax('Decembr', 'MMM', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('Decembr', 'MMMM', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('Decemberary', 'MMM', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('Decemberary', 'MMMM', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('asdf', 'MMM', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('asdf', 'MMMM', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('0', 'd', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('32', 'd', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('12345', 'd', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('02-31', 'M-d', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('04-31', 'M-d', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('2001-02-29', 'YYYY-M-d', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('1999 366', 'yyyy D', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('2000 366 2001', 'yyyy D yyyy', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('0', 'D', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('367', 'D', 'UTC'); -- { serverError 41 }
...
--- invalid hour od day
select parseDateTimeInJodaSyntax('24', 'H', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('-1', 'H', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('123456789', 'H', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('25', 'k', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('0', 'k', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('123456789', 'k', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('12', 'K', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('-1', 'K', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('123456789', 'K', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('13', 'h', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('0', 'h', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('123456789', 'h', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('60', 'm', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('-1', 'm', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('123456789', 'm', 'UTC'); -- { serverError 41 }
...
select parseDateTimeInJodaSyntax('60', 's', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('-1', 's', 'UTC'); -- { serverError 41 }
select parseDateTimeInJodaSyntax('123456789', 's', 'UTC'); -- { serverError 41 }

-- integer overflow in AST Fuzzer
select parseDateTimeInJodaSyntax('19191919191919191919191919191919', 'CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC', 'UTC'); -- { serverError 41 }
