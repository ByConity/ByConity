...
DROP TABLE IF EXISTS idm_ods_xz_inst_xz_hic_app_user_evt_ri_local;
DROP TABLE IF EXISTS idm_ods_xz_inst_xz_hic_web_user_evt_ri;
DROP TABLE IF EXISTS idm_ods_xz_inst_xz_hic_web_user_evt_ri_local;
DROP TABLE IF EXISTS idm_dwd_comm_xz_bh_page_mapping_df;
DROP TABLE IF EXISTS idm_dwd_comm_xz_bh_page_mapping_df_local;

CREATE TABLE idm_ods_xz_inst_xz_hic_app_user_evt_ri_local
(
etltime DateTime ,
recvtime DateTime ,
...
CREATE TABLE idm_ods_xz_inst_xz_hic_app_user_evt_ri AS idm_ods_xz_inst_xz_hic_app_user_evt_ri_local
ENGINE = Distributed(test_shard_localhost, currentDatabase(), 'idm_ods_xz_inst_xz_hic_app_user_evt_ri_local');

CREATE TABLE idm_ods_xz_inst_xz_hic_web_user_evt_ri_local
(
etltime DateTime ,
...
CREATE TABLE  idm_ods_xz_inst_xz_hic_web_user_evt_ri AS  idm_ods_xz_inst_xz_hic_web_user_evt_ri_local ENGINE = Distributed(test_shard_localhost,  currentDatabase(), 'idm_ods_xz_inst_xz_hic_web_user_evt_ri_local');

CREATE TABLE idm_dwd_comm_xz_bh_page_mapping_df_local
(
...
CREATE TABLE idm_dwd_comm_xz_bh_page_mapping_df AS idm_dwd_comm_xz_bh_page_mapping_df_local
ENGINE = Distributed(test_shard_localhost, currentDatabase(), 'idm_dwd_comm_xz_bh_page_mapping_df_local');
...
(
    ...
    (
        SELECT
            ...
            a.btn_title_map['user_id'] AS user_id,
            a.btn_title_map['user_type'] AS user_type,
            a.page_title AS page_title,
            a.page_id AS page_id,
            a.btn_id AS btn_id,
            a.btn_title AS btn_title,
