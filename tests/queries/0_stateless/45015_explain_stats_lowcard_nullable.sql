...
drop table if exists test_explain_stats_nlc_local;
drop table if exists test_explain_stats_nlc;
create table test_explain_stats_nlc_local (
    id UInt64,
...
create table test_explain_stats_nlc as test_explain_stats_nlc_local engine=Distributed(test_shard_localhost, currentDatabase(), test_explain_stats_nlc_local, rand());
