...
SET enable_optimizer=0; -- GROUPING SETS has yet supported by optimizer
...
CREATE TABLE grouping_sets_dist
(
    fact_1_id   Int32,
    fact_2_id   Int32,
    fact_3_id   Int32,
    fact_4_id   Int32,
    sales_value Int32
) ENGINE = Distributed(test_shard_localhost, currentDatabase(), grouping_sets);

SELECT fact_1_id, fact_2_id, fact_3_id, SUM(sales_value) AS sales_value from grouping_sets_dist
GROUP BY GROUPING SETS ((fact_1_id, fact_2_id), (fact_1_id, fact_3_id))
ORDER BY fact_1_id, fact_2_id, fact_3_id;

SELECT fact_1_id, fact_2_id, fact_3_id, fact_4_id, SUM(sales_value) AS sales_value from grouping_sets_dist
