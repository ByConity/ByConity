drop table if exists tuple_test_local;
...
create table tuple_test_local(a Int32,b Tuple(Int32,String)) ENGINE = MergeTree() order by a;
create table tuple_test as tuple_test_local engine = Distributed(test_shard_localhost, currentDatabase(),tuple_test_local);
