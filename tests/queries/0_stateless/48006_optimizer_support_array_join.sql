...
CREATE TABLE array_local(s String, arr1 Array(UInt8),arr2 Array(String)) ENGINE = MergeTree() order by s;
CREATE TABLE array_test AS array_local Engine=Distributed(test_shard_localhost, currentDatabase(), array_local);
