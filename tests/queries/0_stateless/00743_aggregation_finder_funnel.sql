...
<<<<<<< HEAD:tests/queries/4_cnch_stateless/00743_aggregation_finderfunnel.sql
...
=======
CREATE TABLE funnel_test (uid UInt32 default 1, timestamp UInt64, event UInt32, prop String) engine=CnchMergeTree() order by uid;
>>>>>>> c905d9b5584 (Merge branch 'merge_cnch_ce' into 'cnch-ce-merge'):tests/queries/0_stateless/00743_aggregation_finder_funnel.sql
