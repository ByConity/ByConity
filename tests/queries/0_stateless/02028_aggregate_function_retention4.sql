...
CREATE TABLE test_func_retention4 (`hash_uid` String, `server_time` UInt64, first_day UInt8) Engine = MergeTree PARTITION BY toDate(server_time) ORDER BY server_time;
