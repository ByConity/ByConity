...
!!! note "Note" **SimpleAggregateFunction(func, Type)** has the same value appearance and storage method as **Type**, so you don't need to apply with **-Merge**/\*_-State_ \* suffix function.
