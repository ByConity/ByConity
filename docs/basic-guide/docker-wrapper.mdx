...
The docker wrapper image can be upgraded by following this [guide](https://github.com/ByConity/ByConity/tree/master/docker/executable_wrapper/Update_docker_image.md). Please follow the below steps:
