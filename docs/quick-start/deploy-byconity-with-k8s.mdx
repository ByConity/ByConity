...
```
The official provides a Helm configuration YAML file for high availability, eg：https://github.com/ByConity/byconity-deploy/blob/master/examples/k8s/value_HA_example.yaml。
