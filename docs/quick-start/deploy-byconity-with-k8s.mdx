...
```
The official provides a Helm configuration YAML file [value_HA_example.yaml](https://github.com/ByConity/byconity-deploy/blob/master/exampes/k8s/value_HA_example.yml) ofor high availability.
