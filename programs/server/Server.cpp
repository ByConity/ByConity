...
int Server::main(const std::vector<std::string> & /*args*/)
{
    ...
    size_t disk_urs_meta_cache_size = config().getUInt64("disk_unique_row_store_meta_cache_size", 1073741824); /// 1GB
    size_t disk_urs_data_cache_size = config().getUInt64("disk_unique_row_store_data_cache_size", 1073741824); /// 1GB
