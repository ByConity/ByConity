...
# start services
ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/tso0/asan.tso0.log nohup /clickhouse/bin/tso-server --config-file ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/tso0.xml >/dev/null 2>&1 &
#sleep 2
#ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/tso1/asan.tso1.log nohup /clickhouse/bin/tso-server --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/tso1.xml >/dev/null 2>&1 &
#sleep 2
#ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/tso2/asan.tso2.log nohup /clickhouse/bin/tso-server --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/tso2.xml >/dev/null 2>&1 &
sleep 2
#ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/resource-manager0/asan.rm0.log nohup /clickhouse/bin/resource_manager --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/rm0.xml  >/dev/null 2>&1 &
#sleep 2
#ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/resource-manager1/asan.rm1.log nohup /clickhouse/bin/resource_manager --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/rm1.xml  >/dev/null 2>&1 &
#sleep 2
ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/server/asan.server.log nohup /clickhouse/bin/clickhouse-server --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/server.xml >/dev/null 2>&1 &
sleep 2
...
sleep 2
ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/daemon-manager/asan.daemon_manager.log nohup /clickhouse/bin/daemon-manager  --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/daemon-manager.xml  >/dev/null 2>&1 &
sleep 2
# ASAN_OPTIONS=halt_on_error=false,log_path=/artifacts/udf_manager/asan.udf_manager.log nohup /clickhouse/bin/udf_manager_server --config-file  ${APP_ROOT}/.codebase/ci_scripts/cnch_config/2_backward_compability/config/udf-manager.xml >/dev/null 2>&1 &
