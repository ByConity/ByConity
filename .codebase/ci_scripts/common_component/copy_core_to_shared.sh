...
do
  ...
  do
    ...
    python3 /home/code/.codebase/ci_scripts/common_component/lark_bot/extract_gdb_log.py --log-path ${ARTIFACT_FOLDER_PATH}/${FILES}_coredump_backtrace.log
...
do
  ...
  do
    ...
    python3 /home/code/.codebase/ci_scripts/common_component/lark_bot/extract_gdb_log.py --log-path ${FILES}_minidump_backtrace.log
  done
done

# coredump lark bot
python3 /home/code/.codebase/ci_scripts/common_component/lark_bot/main.py --minidump-path "${MINIDUMP_FILE_PATH}" --coredump-path "${CORE_FILE_PATH}"
