...
if(NOT EXISTS "${ClickHouse_SOURCE_DIR}/contrib/libhdfs3-open/include/hdfs/hdfs.h")
    if(USE_INTERNAL_HDFS3_LIBRARY)
        message(WARNING "submodule contrib/libhdfs3-open is missing. to fix try run: \n git submodule update --init --recursive")
...
elseif(NOT MISSING_INTERNAL_HDFS3_LIBRARY AND LIBGSASL_LIBRARY AND LIBXML2_LIBRARIES)
    set(HDFS3_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/contrib/libhdfs3-open/include")
