...
elseif(ENABLE_AWS_GLUE OR USE_INTERNAL_AWS_GLUE_LIBRARY)
    message (${RECONFIGURE_MESSAGE_LEVEL} "Can't use AWS_GLUE on FreeBSD")
endif()


option(USE_INTERNAL_AWS_GLUE_LIBRARY "Set to FALSE to use system AWS_GLUE instead of bundled (experimental set to OFF on your own risk)"
       ON)

if (NOT USE_INTERNAL_POCO_LIBRARY AND USE_INTERNAL_AWS_GLUE_LIBRARY)
    message (FATAL_ERROR "Currently AWS_GLUE support can be built only with internal POCO library")
endif()

if (NOT USE_INTERNAL_AWS_GLUE_LIBRARY)
