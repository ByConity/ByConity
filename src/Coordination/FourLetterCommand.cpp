...
constexpr static auto * SERVER_NOT_ACTIVE_MSG = "This instance is not currently serving requests";
...
int32_t IFourLetterCommand::toCode(const std::string_view & name)
{
    int32_t res = *reinterpret_cast<const int32_t *>(name.data());
    return __builtin_bswap32(res);
}
