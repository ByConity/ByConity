...
public:
    ...
    static constexpr auto type_id = TypeId<IPv4>;

    const char * getFamilyName() const override { return TypeName<IPv4>; }
...
public:
    ...
    static constexpr auto type_id = TypeId<IPv6>;

    const char * getFamilyName() const override { return TypeName<IPv6>; }
    TypeIndex getTypeId() const override { return type_id; }
