...
ReclusteringManagerThread::ReclusteringManagerThread(Context & context, const StorageID & storage_id)
    : ICnchBackgroundThread(CnchBGThreadType::Clustering, context, storage_id)
{
}
