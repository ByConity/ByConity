...
using QualifiedTableNames = std::vector<QualifiedTableName>;
using QualifiedTableNamePredicate = std::pair<QualifiedTableName, std::string>;
using QualifiedTableNamePredicates = std::unordered_set<QualifiedTableNamePredicate>;
