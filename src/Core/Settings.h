...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, enable_hive_distributed_reading, false, "Enable hive distributed reading", 0) \
    M(Bool, enable_hive_distributed_reading_work_stealing, false, "Enable hive distibuted reading work stealing", 0) \
