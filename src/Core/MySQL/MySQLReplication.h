...
namespace MySQLReplication
{
    ...
    public:
        ...
        void dump(WriteBuffer & out) const override;
        MySQLEventType type() const override { return MYSQL_DRY_RUN_EVENT; }
    ...
    public:
        ...
        virtual void setBinlogFile(String file_name) = 0;
    ...
    public:
        ...
        void setBinlogFile(String file_name) override { position.binlog_name = std::move(file_name); }
