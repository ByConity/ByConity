...
public:
    ...
    static String generateName(size_t exchange_id) { return fmt::format("BroadcastExchangeSink[{}]", exchange_id); }

    static String generateNameForTest() { return fmt::format("BroadcastExchangeSink[{}]", -1); }
