...
#include <Processors/Exchange/DataTrans/IRemoteBroadcastSender.h>
#include <brpc/stream.h>

namespace DB
{
class BrpcRemoteBroadcastSender : public IRemoteBroadcastSender
{
public:
    ...
    void waitAllReceiversReady(Int32 timeout_ms) override;
