...
#include <Processors/Exchange/DataTrans/IRemoteBroadcastReceiver.h>
#include <brpc/stream.h>
#include <Poco/Logger.h>

namespace DB
{
class BrpcRemoteBroadcastReceiver : public std::enable_shared_from_this<BrpcRemoteBroadcastReceiver>, IRemoteBroadcastReceiver
{
public:
    ...
    void registerToSender(UInt32 timeout_ms) override;
    DataTransPacket recv(UInt32 timeout_ms) override;
    void finish(Int32 status_code) override;
