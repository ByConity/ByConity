...
private:
    ...
    bool parseImpl(Pos & pos, ASTPtr & node, Expected & expected) override
    {
        ...
        ParserLiteral literal_parser(DialectType::CLICKHOUSE);

        const char * operators[] = {"=", "equals", nullptr};
        ParserLeftAssociativeBinaryOperatorList enum_parser(operators, std::make_unique<ParserLiteral>(DialectType::CLICKHOUSE));
