    ...
    bool throw_on_error)
{
    ...
    {
        throw S3Exception(error,
            fmt::format("Failed to get object info: {}. HTTP response code: {}",
    ...
    bool for_disk_s3)
{
    ...
    throw S3Exception(error,
        fmt::format("Failed to check existence of key {} in bucket {}: {}",key, bucket, error.GetMessage()));
}
    ...
    std::string_view description)
{
    ...
    throw S3Exception(error, fmt::format("{}Object {} in bucket {} suddenly disappeared: {}",
