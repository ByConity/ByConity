...
class PlanCheckTpcdsOnlyPlan : public ::testing::Test
{
public:
    static void SetUpTestSuite()
    {
        ...
        tester->setLabel("not_show_statistics");
    }
