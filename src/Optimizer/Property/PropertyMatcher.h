...
public:
    static bool matchNodePartitioning(
        const Context & context, Partitioning & required, bool enforce_not_match, const Partitioning & actual, const SymbolEquivalences & equivalences = {}, const Constants & constants = {});
