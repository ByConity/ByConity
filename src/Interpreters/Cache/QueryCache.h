...
/// get maximum among the update time of all timetable
...
public:
    ...
    struct Key
    {
        ...
        /// CNCH timestamp for invalidation
        TxnTimestamp cnch_txn = 0;
...
public:
    ...
    private:
        ...
        const TxnTimestamp source_update_time;
        ...
        Writer(Cache & cache_, const Key & key_,
            ...
            TxnTimestamp source_update_time);
    ...
    private:
        Reader(Cache & cache_, const Key & key, TxnTimestamp source_update_time, const std::lock_guard<std::mutex> &);
    ...
    Reader createReader(const Key & key, TxnTimestamp source_update_time);
    Writer createWriter(const Key & key, std::chrono::milliseconds min_query_runtime, bool squash_partial_results, size_t max_block_size, size_t max_query_cache_size_in_bytes_quota, size_t max_query_cache_entries_quota, TxnTimestamp source_update_time);
