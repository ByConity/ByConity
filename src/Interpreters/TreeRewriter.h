...
private:
    static void normalize(ASTPtr & query, Aliases & aliases, const NameSet & source_columns_set, bool ignore_alias, const Settings & settings, bool allow_self_aliases, const ContextPtr & context_, ConstStoragePtr storage_ = {}, const StorageMetadataPtr & metadata_snapshot_ = {});
};
