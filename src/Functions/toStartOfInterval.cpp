...
namespace
{
    ...
    struct Transform<IntervalKind::Hour>
    {
        ...
        static UInt32 execute(UInt16, UInt64, const DateLUTImpl &) { throwDateIsNotSupported(function_name); }
        static UInt32 execute(Int32, UInt64, const DateLUTImpl &) { throwDateIsNotSupported(function_name); }
