...
public:
    ...
    DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName & arguments) const override
    {
        ...
        **/
        ...
        return std::make_shared<DataTypeDecimal<Decimal256>>(DecimalUtils::max_precision<Decimal256>, scale);
    }
...
private:
    ...
    ColumnPtr resolveOverload(const ColumnsWithTypeAndName & arguments, const DataTypePtr & result_type) const
    {
        ...
        {
            using DividendType = DataTypeDecimal<Decimal32>;
            if (which_divisor.isDecimal32())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal32>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
            else if (which_divisor.isDecimal64())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal64>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
            else if (which_divisor.isDecimal128())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal128>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
            else if (which_divisor.isDecimal256())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal256>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
        }

        else if (which_dividend.isDecimal64())
        {
            using DividendType = DataTypeDecimal<Decimal64>;
            if (which_divisor.isDecimal32())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal32>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
            else if (which_divisor.isDecimal64())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal64>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
        ...
        {
            using DividendType = DataTypeDecimal<Decimal128>;
            if (which_divisor.isDecimal32())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal32>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
            else if (which_divisor.isDecimal64())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal64>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
        ...
        {
            using DividendType = DataTypeDecimal<Decimal256>;
            if (which_divisor.isDecimal32())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal32>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
            else if (which_divisor.isDecimal64())
                return DecimalArithmeticsImpl<DividendType, DataTypeDecimal<Decimal64>, DataTypeDecimal<Decimal256>, Transform>::execute(Transform{}, arguments, result_type);
