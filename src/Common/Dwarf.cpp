...
void Dwarf::LineNumberVM::init()
{
    ...
    if (version_ <= 4)
    {
        ...
        v4_.includeDirectories = std::string_view(tmp, header.data() - tmp);
        ...
        v4_.fileNames = std::string_view(tmp, header.data() - tmp);
    }
    else if (version_ == 5)
    {
        ...
        v5_.directoryEntryFormat = std::string_view(tmp, header.data() - tmp);
        ...
        v5_.directories = std::string_view(tmp, header.data() - tmp);
        ...
        v5_.fileNameEntryFormat = std::string_view(tmp, header.data() - tmp);
        ...
        v5_.fileNames = std::string_view(tmp, header.data() - tmp);
    }
}
