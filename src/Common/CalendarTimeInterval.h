...
struct CalendarTimeInterval
{
    UInt64 seconds = 0;
    UInt64 months = 0;
    bool is_refresh_interval_unit = false;
    ...
    /// Refresh materialized view only accept day/hour/minute/second with on interval time
    void assertRefreshUnit() const;
