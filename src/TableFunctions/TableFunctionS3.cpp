...
void TableFunctionS3::parseArgumentsImpl(ASTs & args, const ContextPtr & context)
{
    ...
    {
        size_t count = StorageS3::evalArgsAndCollectHeaders(args, configuration.headers_from_ast, context);
        ...
        if (args_to_idx.contains("secret_access_key"))
            configuration.auth_settings.access_key_secret = checkAndGetLiteralArgument<String>(args[args_to_idx["secret_access_key"]], "secret_access_key");
...
{
    {
        ...
        size_t count = StorageS3::evalArgsAndCollectHeaders(args, tmp_headers, context);
