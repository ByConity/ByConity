...
constexpr auto UNIQUE_ROW_STORE_COLUMNS_NAME = "row_store_columns.txt";
constexpr auto UNIQUE_ROW_STORE_COLUMNS_DELETE_BITMAP_NAME = "row_store_columns_delete.del";
