...
public:
    ...
    size_t readRows(size_t from_mark, size_t from_row, size_t max_rows_to_read, Columns & res_columns) override;
...
private:
    ...
    size_t resumableReadRows(size_t from_mark, bool continue_reading, size_t max_rows_to_read, Columns & res_columns);
