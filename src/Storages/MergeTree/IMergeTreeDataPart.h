...
enum class PartialUpdateState
{
    NotPartialUpdate,  /// part is written in non-partial update mode
    RWProcessNeeded,   /// part is written in partial update mode(RW) and requires further processing
    RWProcessFinished, /// part is written in partial update mode(RW) and processing finished
};
...
public:
    ...
    bool needPartialUpdateProcess() const { return partial_update_state == PartialUpdateState::RWProcessNeeded; }
