...
po::variables_map parseOptions(int argc, char ** argv)
{
    ...
    desc.add_options()("ak", po::value<string>(), "ak")("sk", po::value<string>(), "sk")("session", po::value<string>(), "session")(
        "endpoint", po::value<string>(), "endpoint")("region", po::value<string>(), "region")(
        "catalog_id", po::value<string>(), "catalog_id")("logging_level", po::value<string>()->default_value("debug"), "logging level")(
...
{
    DB::S3::PocoHTTPClientConfiguration conf = DB::S3::ClientFactory::instance().createClientConfiguration(
        opts["endpoint"].as<std::string>(), DB::RemoteHostFilter(), 3, 10 * 1000, 1024, false);
