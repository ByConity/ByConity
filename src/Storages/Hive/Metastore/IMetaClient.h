...
public:
    ...
    getPartitionsByFilter(const String & db_name, const String & table_name, const String & filter) = 0;
    virtual std::optional<TableStatistics>
    getTableStats(const String & db_name, const String & table_name, const Strings & col_names, bool merge_all_partition) = 0;
    ...
    virtual ApacheHive::PartitionsStatsResult getPartitionStats(
