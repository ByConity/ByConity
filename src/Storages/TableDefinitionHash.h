...
{
public:
    TableDefinitionHash():determin_hash(0),v1_hash(0),v2_hash(0) {}
    TableDefinitionHash(UInt64 determin_hash_, UInt64 v1_hash_, UInt64 v2_hash_)
        :determin_hash(determin_hash_), v1_hash(v1_hash_), v2_hash(v2_hash_) {}
    ...
    {
        return hash_value == determin_hash || hash_value == v1_hash || hash_value == v2_hash; 
    }
