...
namespace
{
    ...
    public:
        ...
        virtual const char * Name() const override { return "leveldb.BuiltinBloomFilter2"; }
        ...
        virtual bool KeyMayMatch(const Slice & key, const Slice & bloom_filter) const override
        {
...
// FIXME replace with rocksdb's full filter impl
