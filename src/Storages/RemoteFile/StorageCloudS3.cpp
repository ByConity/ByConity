...
{
    return std::make_unique<WriteBufferFromByteS3>(config.client, config.uri.bucket, key, config.rw_settings.min_upload_part_size, config.rw_settings.max_single_part_upload_size, true);
}
