...
struct S3Settings
{
    struct ReadWriteSettings
    {
        ...
        inline bool operator==(const ReadWriteSettings & other) const
        {
            return max_single_read_retries == other.max_single_read_retries
                ...
                && max_list_nums == other.max_list_nums
                && max_timeout_ms == other.max_timeout_ms;
        }
    ...
    {
        return endpoint == other.endpoint && auth_settings == other.auth_settings && rw_settings == other.rw_settings;
    }
};
