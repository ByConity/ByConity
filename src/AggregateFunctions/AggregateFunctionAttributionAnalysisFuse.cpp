...
#include "AggregateFunctionAttributionAnalysisFuse.h"
...
namespace
{
    AggregateFunctionPtr createAggregateFunctionAttributionAnalysisFuse(const std::string & name, const DataTypes & argument_types, const Array & params, const Settings *)
    {
...
void registerAggregateFunctionAttributionAnalysisFuse(AggregateFunctionFactory & factory)
{
    factory.registerFunction("attributionAnalysisFuse", createAggregateFunctionAttributionAnalysisFuse,
                             AggregateFunctionFactory::CaseInsensitive);
    // TODO: remove this alias
    factory.registerAlias("attributionAnalysisMerge", "attributionAnalysisFuse", AggregateFunctionFactory::CaseInsensitive);
}
}
