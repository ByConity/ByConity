...
public:
    ...
    void toProto(Protos::DistinctStep & proto, bool for_hash_equals = false) const;
    static std::shared_ptr<DistinctStep> fromProto(const Protos::DistinctStep & proto, ContextPtr context);
