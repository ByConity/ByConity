...
public:
    ...
    void toProto(Protos::PartialSortingStep & proto, bool for_hash_equals = false) const;
    static std::shared_ptr<PartialSortingStep> fromProto(const Protos::PartialSortingStep & proto, ContextPtr context);
